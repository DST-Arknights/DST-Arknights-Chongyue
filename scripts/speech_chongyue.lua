return
{
	ACTIONFAIL =
	{
        APPRAISE =
        {
            NOTNOW = "还不是时候。",		--给牛评价 时间不对
        },
        REPAIR =
        {
            WRONGPIECE = "换一种方法吧。",		--化石骨架拼接错误
        },
        BUILD =
        {
            MOUNTED = "骑行时三心二意会酿成大错。",		--建造失败（骑乘状态）
            HASPET = "朋友不在多 知己两三足矣。",		--建造失败（已经有一个宠物了）
			TICOON = "。。。",		--暂无注释
        },
		SHAVE =
		{
			AWAKEBEEFALO = "掩耳盗铃？",		--给醒着的牛刮毛
			GENERIC = "胜败乃常事",		--刮牛毛失败
			NOBITS = "涸泽而渔？",		--给没毛的牛刮毛
            REFUSE = "only_used_by_woodie",		--暂无注释
            SOMEONEELSESBEEFALO = "勿行。",		--给别人的牛刮毛
		},
		STORE =
		{
			GENERIC = "装满了。",		--存放东西失败
			NOTALLOWED = "不合适。",		--存放东西--不被允许
			INUSE = "凡事讲究一个先来后到嘛。",		--别人正在用箱子
            NOTMASTERCHEF = "术业有专攻。",		--非厨师尝试往便携锅里塞东西
		},
        CONSTRUCT =
        {
            INUSE = "稍安勿躁。",		--建筑正在使用
            NOTALLOWED = "难行。",		--建筑不允许使用
            EMPTY = "需要一些建造材料。",		--建筑空了
            MISMATCH = "哎。。。",		--升级套件错误（目前用不到）
            NOTREADY = "情况稳定下来之后它可能会出现。",		--暂无注释
        },
		RUMMAGE =
		{
			GENERIC = "难行",		--打开箱子失败
			INUSE = "在找什么？兴许我可以帮忙。",		--打开箱子 正在使用
            NOTMASTERCHEF = "术业有专攻。",		--非厨师尝试打开便携锅
		},
		UNLOCK =
        {
        	WRONGKEY = "做不到。",		--暂无注释
		...
		ACTIVATE =
		{
			...
			EMPTY_CATCOONDEN = "糟糕，我还以为里面肯定会有好东西呢！",		--暂无注释
			...
			KITCOON_HIDEANDSEEK_ONE_GAME_PER_DAY = "我想今天就到此为止吧。",		--暂无注释
            MANNEQUIN_EQUIPSWAPFAILED = "他应该穿不上。",		--暂无注释
            PILLOWFIGHT_NO_HANDPILLOW = "我需要一个枕头来战斗！",		--暂无注释
            NOTMYBERNIE = "未找到",		--暂无注释
		},
		OPEN_CRAFTING =
		{
            PROFESSIONALCHEF = "闻道有先后。",		--暂无注释
			SHADOWMAGIC = "那是什么。",		--暂无注释
		},
        COOK =
        {
            GENERIC = "不知道我的那些弟妹们有没有按时吃饭。",		--做饭失败
            INUSE = "闻起来，不错？",		--做饭失败-别人在用锅
            TOOFAR = "有点远，但是试试也无妨！",		--做饭失败-太远
        },
        START_CARRAT_RACE =
        {
            NO_RACERS = "我肯定是漏掉了什么东西。",		--试图开始胡萝卜鼠比赛 但是没有放胡萝卜鼠
        },
		DISMANTLE =
		{
			COOKING = "我可不想浪费了这佳肴。",		--拆便携的物品-正在做饭
			INUSE = "莫慌。",		--拆便携的物品-正在使用
			NOTEMPTY = "博士，做菜前要洗锅。",		--拆便携的物品-里面有物品
        },
        FISH_OCEAN =
		{
			TOODEEP = "愿者上钩。",		--拿普通鱼竿去深海钓鱼
		},
        OCEAN_FISHING_POND =
		{
			WRONGGEAR = "杀鸡焉用牛刀？",		--拿深海鱼竿去普通的池子里钓鱼
		},
        READ =
        {
        ...
        GIVE =
        {
            ...
            TERRARIUM_REFUSE = "也许我应该用不同种类的燃料进行实验……",		--暂无注释
            TERRARIUM_COOLDOWN = "树没长回来之前应该给不了东西。",		--暂无注释
            NOTAMONKEY = "我不会说猴话。",		--暂无注释
            QUEENBUSY = "她好像在忙。",		--暂无注释
        },
        GIVETOPLAYER =
        {
            FULL = "你的口袋满了。",		--给玩家一个东西 -但是背包满了
            DEAD = "物是人非，难免悲伤。",		--给死亡的玩家一个东西
            SLEEPING = "给你塞点压岁钱（",		--给睡觉的玩家一个东西
            BUSY = "忙，都忙，忙点好。",		--给忙碌的玩家一个东西
        },
        GIVEALLTOPLAYER =
        {
            FULL = "你的口袋太满了！",		--给人一组东西 但是背包满了
            DEAD = "物是人非，难免悲伤。",		--给于死去的玩家一组物品
            SLEEPING = "不省人事了。",		--给于正在睡觉的玩家一组物品
            BUSY = "忙，忙点好。",		--给于正在忙碌的玩家一组物品
        },
        WRITE =
        {
        ...
        CHANGEIN =
        {
            ...
            INUSE = "等待。",		--衣橱有人占用
            NOTENOUGHHAIR = "我可不会生发。",		--给牛换装 牛毛被刮光了
            NOOCCUPANT = "等一下我将进行无实物表演。",		--给牛换装 没牛？
        },
        ATTUNE =
        {
            NOHEALTH = "欠佳。",		--制造肉雕像血量不足
        },
        MOUNT =
        {
            TARGETINCOMBAT = "骑牛难下！",		--骑乘，牛正在战斗
            INUSE = "你好？",		--骑乘（牛被占据）
			SLEEPING = "该醒醒了！",		--暂无注释
        },
        SADDLE =
        {
            TARGETINCOMBAT = "冷静一下，朋友。",		--给战斗状态的牛上鞍
        },
        TEACH =
        {
			...
			MESSAGEBOTTLEMANAGER_NOT_FOUND = "光线太暗，我什么都看不到！",--Likely trying to read messagebottle treasure map in caves		--在地下使用漂流瓶
            STASH_MAP_NOT_FOUND = "没看到“X就是地点的标志”。那帮家伙准是忘记画了。",-- Likely trying to read stash map  in world without stash                  		--暂无注释
        },
        WRAPBUNDLE =
        {
        ...
        PICKUP =
        {
            ...
            NOTMINE_YOTC =
            {
                "你可不是我的胡萝卜鼠。",		--捡起别人的胡萝卜鼠
                "噢，它咬我！",		--捡起别人的胡萝卜鼠
            },
			NO_HEAVY_LIFTING = "only_used_by_wanda",		--暂无注释
            FULL_OF_CURSES = "我才不要碰。",		--暂无注释
        },
        SLAUGHTER =
        {
        ...
        SAIL =
        {
        	REPAIR = "它不需要修理。",		--修复帆？？？ 没调用
        },
        ROW_FAIL =
        {
            BAD_TIMING0 = "太快了！",		--划船失败 第1次
            BAD_TIMING1 = "时机不对！",		--划船失败 第2次
            BAD_TIMING2 = "别再犯了！",		--划船失败 第3次
        },
        LOWER_SAIL_FAIL =
        {
            "哎！",		--降帆失败
        ...
        BATHBOMB =
        {
            GLASSED = "不行，表面都变玻璃了。",		--月岛池子 里面已经有玻璃了
            ALREADY_BOMBED = "别浪费沐浴球。",		--月岛池子 已经有人放进去沐浴球了
        },
		GIVE_TACKLESKETCH =
		{
			DUPLICATE = "不对，不对。",		--给陶盘已经有的图纸
		},
		COMPARE_WEIGHABLE =
		{
            FISH_TOO_SMALL = "这家伙太小了。",		--鱼秤 手上的没鱼缸里的大
            OVERSIZEDVEGGIES_TOO_SMALL = "还不够沉。",		--蔬菜秤 手上的没秤上的大
		},
        BEGIN_QUEST =
        {
        ...
        {
            GENERIC = "不剩什么需要学的了。",		--研究作物失败
            FERTILIZER = "博士，你见过我那个妹妹吗。黍。",		--研究肥料失败
        },
        FILL_OCEAN =
        {
            UNSUITABLE_FOR_PLANTS = "出于某些原因，植物不喜欢咸水。",		--水壶在海里灌水
        },
        POUR_WATER =
        {
            OUT_OF_WATER = "糟糕，没水了。",		--水壶空了
        },
        POUR_WATER_GROUNDTILE =
        {
            OUT_OF_WATER = "我的浇水壶干了。",		--水壶空了
        },
        USEITEMON =
        {
            BEEF_BELL_INVALID_TARGET = "您真是有兴致。",		--对无效目标使用牛铃铛
            BEEF_BELL_ALREADY_USED = "这头弗娄牛已经属于别人了。",		--对已有主人的牛使用牛铃铛
            BEEF_BELL_HAS_BEEF_ALREADY = "我不需要整个牛群。",		--已有牛 使用牛铃铛
        },
        HITCHUP =
        {
            NEEDBEEF = "有铃铛就能和皮弗娄牛交友了。",		--将牛拴起来 没有牛
            NEEDBEEF_CLOSER = "我的皮弗娄牛伙计离我太远了。",		--将牛拴起来 牛太远
            BEEF_HITCHED = "我的皮弗娄牛已经拴好了。",		--将牛拴起来 牛已经被拴起来了
            INMOOD = "我的皮弗娄牛看起来太好动了。",		--将牛拴起来 牛在发情
        },
        MARK =
        {
            ALREADY_MARKED = "我已经选好了。",		--选择牛 已经选择了
            NOT_PARTICIPANT = "我没有选手参赛。",		--选择牛 不是参与者（已经开始了）?
        },
        YOTB_STARTCONTEST =
        {
            DOESNTWORK = "看来这里并不支持艺术。",		--牛年活动 NPC不在工作
            ALREADYACTIVE = "他可能忙着比别的比赛呢。",		--牛年活动 NPC已经激活
        },
        YOTB_UNLOCKSKIN =
        {
            ALREADYKNOWN = "一个熟悉的样式……这个我已经掌握了！",		--牛年活动 解锁已知皮肤
        },
        CARNIVALGAME_FEED =
        {
            TOO_LATE = "我得快一点！",		--暂无注释
        ...
        HARVEST =
        {
            DOER_ISNT_MODULE_OWNER = "它似乎对科学讨论没有兴趣。",		--暂无注释
        },
		CAST_SPELLBOOK =
		{
	...
	{
		NO_INGREDIENTS = "我似乎缺少一些重要组件。",		--暂无注释
		NO_TECH = "这个需要投入更多科研！",		--暂无注释
		NO_STATION = "我现在制作不了。",		--暂无注释
	},
	ACTIONFAIL_GENERIC = "做不到。",		--动作失败
	ANNOUNCE_BOAT_LEAK = "水越来越多了。",		--船撞了个洞
	ANNOUNCE_BOAT_SINK = "不要惊慌。",		--船漏水
	...
	ANNOUNCE_CHARLIE = "你好？",		--查理即将攻击
	ANNOUNCE_CHARLIE_ATTACK = "我想你这样做并不理智",		--被查理攻击
	ANNOUNCE_CHARLIE_MISSED = "only_used_by_winona", --winona specific		--暂无注释
	ANNOUNCE_COLD = "博士，你冷吗。",		--过冷
	ANNOUNCE_HOT = "和当年战火无异",		--过热
	ANNOUNCE_CRAFTING_FAIL = "缺少一些关键成分。",		--没调用
	ANNOUNCE_DEERCLOPS = "将士们，备战！",		--boss来袭
	...
	{
		GENERIC = "嗯！味道不错",		--吃东西
		PAINFUL = "紧急关头充饥也是不错的。",		--吃怪物肉
		SPOILED = "吃坏肚子要比饥饿更危险。",		--吃腐烂食物
		STALE = "我觉得它开始变质了。",		--吃黄色食物
		INVALID = "。。。",		--拒吃
        YUCKY = "这颜色让我想起一个朋友，有机会和你讲讲吧。",		--吃红色食物
    ...
    ANNOUNCE_SNARED_IVY = "草木皆兵!",		--被针刺旋花攻击
    ...
    ANNOUNCE_HUNT_SUCCESSFUL_FORK = "...",		--暂无注释
    ANNOUNCE_HUNT_WRONG_FORK = "我感到有东西在看着我。",		--暂无注释
    ANNOUNCE_HUNT_AVOID_FORK = "这个踪迹看起来安全些了。",		--暂无注释
	ANNOUNCE_INV_FULL = "我拿不了更多的东西了！",		--身上的物品满了
	ANNOUNCE_KNOCKEDOUT = "嗷，我要被封印了？",		--被催眠
	ANNOUNCE_LOWRESEARCH = "我没从那儿学到什么。",		--没调用（废案）
	ANNOUNCE_MOSQUITOS = "啊！",		--没调用
    ANNOUNCE_NOWARDROBEONFIRE = "救火",		--橱柜着火
    ANNOUNCE_NODANGERGIFT = "怪物在四周，我无法拆礼物！",		--周围有危险的情况下打开礼物
    ANNOUNCE_NOMOUNTEDGIFT = "三心二意会导致严重后果。",		--骑牛的时候打开礼物
	ANNOUNCE_NODANGERSLEEP = "现在还不是休息的时候！",		--危险，不能睡觉
	ANNOUNCE_NODAYSLEEP = "光线太亮了。",		--白天睡帐篷
	ANNOUNCE_NODAYSLEEP_CAVE = "我不累。",		--洞穴里白天睡帐篷
	ANNOUNCE_NOHUNGERSLEEP = "空腹睡觉可不理智，寻点野果来吃吧。",		--饿了无法睡觉
	ANNOUNCE_NOSLEEPONFIRE = "我也是肉身。",		--营帐着火无法睡觉
    ANNOUNCE_NOSLEEPHASPERMANENTLIGHT = "only_used_by_wx78",		--暂无注释
	ANNOUNCE_NODANGERSIESTA = "现在午休太危险了！",		--危险，不能午睡
	ANNOUNCE_NONIGHTSIESTA = "这样会着凉的，去我帐中休息吧。",		--夜晚睡凉棚
	ANNOUNCE_NONIGHTSIESTA_CAVE = "我不认为我在这里能真正放松下来。",		--在洞穴里夜晚睡凉棚
	ANNOUNCE_NOHUNGERSIESTA = "饿...",		--饱度不足无法午睡
	ANNOUNCE_NO_TRAP = "好吧，挺简单的。",		--没有陷阱？？？没调用
	ANNOUNCE_PECKED = "无碍",		--被小高鸟啄
	...
	ANNOUNCE_TOWNPORTALTELEPORT = "要是玉门有这种科技就好了。",		--豪华传送
	ANNOUNCE_CANFIX = "\n我觉得我能修好这个！",		--墙壁可以修理
	...
	ANNOUNCE_WASHED_ASHORE = "衣服弄湿了，但是还活着。",		--落水被冲上岸
    ANNOUNCE_DESPAWN = "我能看见光!",		--下线
	ANNOUNCE_BECOMEGHOST = "你好？",		--变成鬼魂
	ANNOUNCE_GHOSTDRAIN = "战友的离去虽然已经经历很多，但每每想起都会伤神...",		--队友死亡掉san
	...
	{
		GLASS_MED = "里面有东西。",		--月岛科技三个部分被挖开
		GLASS_LOW = "快挖出来了。",		--月岛科技三个部分被挖开
		GLASS_REVEAL = "你自由了！",		--月岛科技三个部分被挖开
		IDOL_MED = "里面有东西。",		--月岛科技三个部分被挖开
		IDOL_LOW = "快挖出来了。",		--月岛科技三个部分被挖开
		IDOL_REVEAL = "你自由了！",		--月岛科技三个部分被挖开
		SEED_MED = "里面有东西。",		--月岛科技三个部分被挖开
		SEED_LOW = "快挖出来了。",		--月岛科技三个部分被挖开
		SEED_REVEAL = "你自由了！",		--月岛科技三个部分被挖开
	},
    ANNOUNCE_SPOOKED = "你看到了吗？！",		--被吓到
	ANNOUNCE_BRAVERY_POTION = "勇气是人类的赞歌。",		--勇气药剂
	ANNOUNCE_MOONPOTION_FAILED = "可能没泡够时间……",		--万圣节月亮药水 对不能变化的物品使用
	ANNOUNCE_EATING_NOT_FEASTING = "我应该跟其他人分享的。",		--冬季盛宴的植物 单人吃（但是没调用）
	ANNOUNCE_WINTERS_FEAST_BUFF = "满满的节日精神！",		--冬季盛宴食物buff开始
	ANNOUNCE_IS_FEASTING = "冬季盛宴快乐！",		--冬季盛宴 大家一起吃
	ANNOUNCE_WINTERS_FEAST_BUFF_OVER = "节过的真快……",		--冬季盛宴食物buff结束
    ...
    ANNOUNCE_FLARE_SEEN = "是谁发出的信号？",		--看见信号弹
    ANNOUNCE_MEGA_FLARE_SEEN = "那个闪光会带来麻烦。",		--暂无注释
    ANNOUNCE_OCEAN_SILHOUETTE_INCOMING = "不好，海怪！",		--深海 轮廓？ 没调用
	ANNOUNCE_LIGHTFIRE =
	{
    ...
    ANNOUNCE_ATTACH_BUFF_ELECTRICATTACK    = "雷公助我！",		--获得电击buff
    ANNOUNCE_ATTACH_BUFF_ATTACK            = "武力充沛！",		--获得攻击加强的buff(目前是指辣椒粉料理)
    ANNOUNCE_ATTACH_BUFF_PLAYERABSORPTION  = "德行充沛！",		--获得防御加强的buff(目前是指大蒜粉料理)
    ANNOUNCE_ATTACH_BUFF_WORKEFFECTIVENESS = "兵贵神速！",		--获得工作效率加强的buff(目前是指蜂蜜粉料理)
    ANNOUNCE_ATTACH_BUFF_MOISTUREIMMUNITY  = "是樟脑丸！",		--获得潮湿免疫的buff(目前是指蓝带鱼排)
    ANNOUNCE_ATTACH_BUFF_SLEEPRESISTANCE   = "气定神闲！",		--获得睡眠减缓的buff(目前是指月蘑菇料理)
    ANNOUNCE_DETACH_BUFF_ELECTRICATTACK    = "雨过天晴。",		--失去电击buff
    ANNOUNCE_DETACH_BUFF_ATTACK            = "短期的刺激，不如久月的操练。",		--失去攻击加强的buff(目前是指辣椒粉料理)
    ANNOUNCE_DETACH_BUFF_PLAYERABSORPTION  = "返璞归真。",		--失去防御加强的buff(目前是指大蒜粉料理)
    ANNOUNCE_DETACH_BUFF_WORKEFFECTIVENESS = "脚踏实地...",		--失去工作效率加强的buff(目前是指蜂蜜粉料理)
    ANNOUNCE_DETACH_BUFF_MOISTUREIMMUNITY  = "潮水奔涌。",		--失去潮湿免疫的buff(目前是指蓝带鱼排)
    ANNOUNCE_DETACH_BUFF_SLEEPRESISTANCE   = "困意侵袭。",		--失去睡眠减缓的buff(目前是指月蘑菇料理)
	ANNOUNCE_OCEANFISHING_LINESNAP = "哎呀，这可难办了。",		--海钓 线崩断了
	ANNOUNCE_OCEANFISHING_LINETOOLOOSE = "哎呀...",		--海钓失败 渔具丢失
	ANNOUNCE_OCEANFISHING_GOTAWAY = "它逃走了。",		--海钓 鱼跑远了
	ANNOUNCE_OCEANFISHING_BADCAST = "甩竿技术有待提高……",		--海钓 抛竿扔地面上去了
	ANNOUNCE_OCEANFISHING_IDLE_QUOTE =
	{
		"我想我会把钓鱼安排到每日事项中？",		--海钓 没上钩的时候闲聊
		"博士，我听说有些人钓鱼会用大量的鱼饵去打窝，可有此事？",		--海钓 没上钩的时候闲聊
		"海洋与沙场有一些相识呢。啊？不是指都没有鱼上钩...",		--海钓 没上钩的时候闲聊
		"难得的空闲时间，真是惬意啊。",		--海钓 没上钩的时候闲聊
	},
	ANNOUNCE_WEIGHT = "我看看？{weight}",		--称重 
	ANNOUNCE_WEIGHT_HEAVY  = "嗯... {weight}？！\n这条鱼可真不小啊!",		--称重 大鱼
	ANNOUNCE_WINCH_CLAW_MISS = "好像没对准。",		--绞绞吸盘 没命中
	ANNOUNCE_WINCH_CLAW_NO_ITEM = "得！两手空空。",		--绞绞吸盘 没东西
    ...
    ANNOUNCE_WEAK_RAT = "这只胡萝卜鼠不在训练的状态。",		--试图训练快饿死的胡萝卜鼠
    ANNOUNCE_CARRAT_START_RACE = "实验——，比赛开始！",		--胡萝卜鼠开始比赛
    ANNOUNCE_CARRAT_ERROR_WRONG_WAY =
	{
        "不，不！方向错了！",		--胡萝卜鼠比赛 跑错方向
        "掉头，士兵，听我指挥。",		--胡萝卜鼠比赛 跑错方向
    },
    ANNOUNCE_CARRAT_ERROR_FELL_ASLEEP = "起床了，该进行早练了。",		--起床了，蠢胡萝卜鼠！
    ANNOUNCE_CARRAT_ERROR_WALKING = "不要用走，跑！",		--胡萝卜鼠比赛 走的慢
    ANNOUNCE_CARRAT_ERROR_STUNNED = "站起来！冲，冲！",		--胡萝卜鼠比赛 惊呆了
    ANNOUNCE_GHOST_QUEST = "only_used_by_wendy",		--温蒂 为小惊吓找玩具 雨我无瓜
    ANNOUNCE_GHOST_HINT = "only_used_by_wendy",		--温蒂 为小惊吓找玩具 雨我无瓜
    ANNOUNCE_GHOST_TOY_NEAR =
	{
        "only_used_by_wendy",		--温蒂 为小惊吓找玩具 在附近 雨我无瓜
    },
	ANNOUNCE_SISTURN_FULL = "only_used_by_wendy",		--姐妹骨灰罐 装满
    ANNOUNCE_ABIGAIL_DEATH = "only_used_by_wendy",		--阿比盖尔死亡 雨我无瓜
    ANNOUNCE_ABIGAIL_RETRIEVE = "only_used_by_wendy",		--阿比盖尔收回 雨我无瓜
	ANNOUNCE_ABIGAIL_LOW_HEALTH = "only_used_by_wendy",		--阿比盖尔低生命 雨我无瓜
    ANNOUNCE_ABIGAIL_SUMMON =
	{
		LEVEL1 = "only_used_by_wendy",		--阿比盖尔召唤LV1 雨我无瓜
		LEVEL2 = "only_used_by_wendy",		--阿比盖尔召唤LV2 雨我无瓜
		LEVEL3 = "only_used_by_wendy",		--阿比盖尔召唤LV3 雨我无瓜
	},
    ANNOUNCE_GHOSTLYBOND_LEVELUP =
	{
		LEVEL2 = "only_used_by_wendy",		--阿比盖尔升级LV2 雨我无瓜
		LEVEL3 = "only_used_by_wendy",		--阿比盖尔升级LV3 雨我无瓜
	},
    ...
    ANNOUNCE_ARCHIVE_NEW_KNOWLEDGE = "来自远古的新知识拓宽了我的思维！",		--地下月岛遗迹 解锁新知识
    ANNOUNCE_ARCHIVE_OLD_KNOWLEDGE = "我早就知道了。",		--地下月岛遗迹 解锁旧知识
    ANNOUNCE_ARCHIVE_NO_POWER = "得给它供点能。",		--地下月岛遗迹 没能量
    ANNOUNCE_PLANT_RESEARCHED =
    {
        "我对这种植物的知识在增长！",		--研究植物
    },
    ANNOUNCE_PLANT_RANDOMSEED = "不知道会长成什么。",		--种下随机种子
    ANNOUNCE_FERTILIZER_RESEARCHED = "我从未想过会把我的科学思想用在……这东西上。",		--研究肥料
	ANNOUNCE_FIRENETTLE_TOXIN =
	{
		"我的五脏六腑都在燃烧！",		--烈火荨麻 buff开始
		"哎哟，太热了！",		--烈火荨麻 buff开始
	},
	ANNOUNCE_FIRENETTLE_TOXIN_DONE = "下次给我那个妹妹带点（",		--烈火荨麻 buff结束
	ANNOUNCE_TALK_TO_PLANTS =
	{
        "生长吧，植物，生长吧！",		--和植物聊天
        "也许你能长成一棵大树？",		--和植物聊天
		"你好，植物。",		--和植物聊天
        "你是否也渴望着别样的视角观察这世间呢？",		--和植物聊天
        "每一株草都有自己的事情。",		--和植物聊天
	},
	ANNOUNCE_KITCOON_HIDEANDSEEK_START = "3,2,1……不管你有没有藏好，我都要开始找！",		--暂无注释
	ANNOUNCE_KITCOON_HIDEANDSEEK_JOIN = "嗷，它们在玩捉迷藏呢。",		--暂无注释
	...
	ANNOUNCE_KITCOON_HIDANDSEEK_FOUND_ONE_MORE = "所以最后一个藏在哪里呢？",		--暂无注释
	ANNOUNCE_KITCOON_HIDANDSEEK_FOUND_LAST_ONE = "我找到最后一个了！",		--暂无注释
	ANNOUNCE_KITCOON_HIDANDSEEK_FOUND_LAST_ONE_TEAM = "{name}找到了最后一个！",		--暂无注释
	...
	ANNOUNCE_KITCOON_FOUND_IN_THE_WILD = "我就说刚刚看到了那边有什么东西在藏着！",		--暂无注释
	ANNOUNCE_TICOON_START_TRACKING	= "他捕捉到了气味！",		--暂无注释
	ANNOUNCE_TICOON_NOTHING_TO_TRACK = "看来他什么都没找到。",		--暂无注释
	ANNOUNCE_TICOON_WAITING_FOR_LEADER = "我应该跟着他！",		--暂无注释
	ANNOUNCE_TICOON_GET_LEADER_ATTENTION = "他很想让我跟着。",		--暂无注释
	ANNOUNCE_TICOON_NEAR_KITCOON = "他一定是发现了什么！",		--暂无注释
	ANNOUNCE_TICOON_LOST_KITCOON = "看来别人找到了他要找的东西。",		--暂无注释
	ANNOUNCE_TICOON_ABANDONED = "我会自己找到那些小家伙的。",		--暂无注释
	ANNOUNCE_TICOON_DEAD = "可怜的家伙……他原本想把我带到哪里呢？",		--暂无注释
    ANNOUNCE_CALL_BEEF = "你给我过来！",		--把牛拴好
    ANNOUNCE_CANTBUILDHERE_YOTB_POST = "放在这里裁判是看不到我的皮弗娄牛的。",		--建造牛舞台 离裁判太远
    ANNOUNCE_YOTB_LEARN_NEW_PATTERN =  "我满满都是皮弗娄牛造型的灵感！",		--牛年活动 学到了新组件
    ANNOUNCE_EYEOFTERROR_ARRIVE = "那是什么——漂浮巨眼？！",		--暂无注释
    ANNOUNCE_EYEOFTERROR_FLYBACK = "终于好了！",		--暂无注释
    ANNOUNCE_EYEOFTERROR_FLYAWAY = "回来，我跟你没完！",		--暂无注释
    ANNOUNCE_CANT_ESCAPE_CURSE = "当然不会那么轻松。",		--暂无注释
    ANNOUNCE_MONKEY_CURSE_1 = "开始有芜猴的感觉了……",		--暂无注释
    ANNOUNCE_MONKEY_CURSE_CHANGE = "呀！我的头发怎么了？！",		--暂无注释
    ...
    ANNOUNCE_OFF_SCRIPT = "我感觉剧本里没写那句。",		--暂无注释
    ANNOUNCE_COZY_SLEEP = "我感觉神清气爽！",		--暂无注释
	ANNOUNCE_TOOL_TOOWEAK = "我需要一把更结实的工具！",		--暂无注释
    ANNOUNCE_LUNAR_RIFT_MAX = "那道闪光！那是月光吗？",		--暂无注释
    ANNOUNCE_SHADOW_RIFT_MAX = "有些阴险的家伙即将到来。",		--暂无注释
    ANNOUNCE_SCRAPBOOK_FULL = "这些我都有了。",		--暂无注释
	...
	BATTLECRY =
	{
		...
		PREY = "形不成行！\n意不在意！",		--战斗 猎物？？大象？
		SPIDER = "你们解决问题，\n只会仰仗干戈吗！",		--战斗 蜘蛛
		SPIDER_WARRIOR = "真是勇猛的将士。",		--战斗 蜘蛛战士
		DEER = "千招百式在一息！",		--战斗 无眼鹿
	},
	COMBAT_QUIT =
	{
		GENERIC = "空拳",		--攻击目标被卡住，无法攻击
		PIG = "传统功夫讲究...",		--退出战斗-猪人
		PREY = "他速度太快了！",		--退出战斗 猎物？？大象？
		SPIDER = "再见。",		-- 退出战斗 蜘蛛
		SPIDER_WARRIOR = "先走一步。",		--退出战斗 蜘蛛战士
	},
	DESCRIBE =
	{
		MULTIPLAYER_PORTAL = "奇怪的东西。",		-- 物品名:"绚丽之门"
        MULTIPLAYER_PORTAL_MOONROCK = "传送，实用的东西。",		-- 物品名:"天体传送门"
        MOONROCKIDOL = "无法理解。",		-- 物品名:"月岩雕像" 制造描述:"重要人物。"
        CONSTRUCTION_PLANS = "少了点什么。",		-- 物品名:未找到
        ANTLION =
        {
        ...
        GLASSSPIKE = "有趣的玩意",		-- 物品名:"玻璃尖刺"
        GLASSBLOCK = "别有一番风味。",		-- 物品名:"玻璃城堡"
        ABIGAIL_FLOWER =
        {
		...
		BOOKSTATION =
		{
			GENERIC = "活到老学到老",		-- 物品名:"书架"->默认 制造描述:"所有图书均须遵循杜威十进制分类法整理。"
			BURNT = "看来图书馆关门了。",		-- 物品名:"书架"->烧焦的 制造描述:"所有图书均须遵循杜威十进制分类法整理。"
		},
        BOOK_BIRDS = "一本鸟书。",		-- 物品名:"世界鸟类大全" 制造描述:"涵盖1000个物种：习性、栖息地及叫声。"
        BOOK_TENTACLES = "也许这个可以用来召唤某个难以直视的东西。",		-- 物品名:"触手的召唤" 制造描述:"让我们来了解一下地下的朋友们！"
        BOOK_GARDENING = "我的某个妹妹应该会喜欢的。",		-- 物品名:"应用园艺学" 制造描述:"讲述培育和照料植物的相关知识。"
		BOOK_SILVICULTURE = "术业有专攻。",		-- 物品名:"应用造林学" 制造描述:"分支管理的指引。"
		BOOK_HORTICULTURE = "我的某个妹妹应该会喜欢的。",		-- 物品名:"园艺学简编版" 制造描述:"讲述培育和照料植物的相关知识。"
        BOOK_SLEEP = "奇怪，这只是五百页的电报码。",		-- 物品名:"睡前故事" 制造描述:"送你入梦的睡前故事。"
        BOOK_BRIMSTONE = "有趣的书。",		-- 物品名:"末日将至！" 制造描述:"世界将在火焰和灾难中终结！"
        BOOK_FISH = "下次钓鱼的时候会有用？",		-- 物品名:"垂钓者生存指南" 制造描述:"让捕鱼变得简单！"
        BOOK_FIRE = "并没有心急火燎的阅读冲动。",		-- 物品名:"意念控火术详解" 制造描述:"使用这些简单的技巧来化解任何火爆的场面。"
        BOOK_WEB = "有人会需要的，但似乎不是我。",		-- 物品名:"克服蛛形纲恐惧症" 制造描述:"要在对方的网络里行走过一里路才能算真正了解一个人。"
        ...
        BOOK_BEES = "学习总是有益。",		-- 物品名:"养蜂笔记" 制造描述:"学习养蜂的基本知识。"
        BOOK_HORTICULTURE_UPGRADED = "我应该和你提过她吧？黍。",		-- 物品名:"园艺学扩展版" 制造描述:"专家分析如何进行高级农作物护理。"
        BOOK_RESEARCH_STATION = "这可真是见多识广的书，但仍然有所遗漏。",		-- 物品名:"万物百科" 制造描述:"万事万物从A到Z的完整指南。"
        BOOK_LIGHT_UPGRADED = "光。",		-- 物品名:"永恒之光之复兴" 制造描述:"全本比之前的简本散发出更闪耀的光芒。"
        ...
        PLAYER =
        {
            ...
            GHOST = "%s 用“心”。",		-- 物品名:"幽灵"
            FIRESTARTER = "烧了它有什么用意吗？%s。",		-- 物品名:未找到
        },
        WILSON =
        {
            GENERIC = "你是？",		-- 物品名:未找到
            ATTACKER = "战胜自己。",		-- 物品名:未找到
            MURDERER = "事情本不必至此的，%s！",		-- 物品名:未找到
            REVIVER = "%s真是让人悲伤。",		-- 物品名:"告密的心" 制造描述:"鬼魂朋友复活了，好可怕。"
            GHOST = "你是我是谁？",		-- 物品名:"幽灵"
            FIRESTARTER = "何意？%s。",		-- 物品名:未找到
        },
        WOLFGANG =
        {
            GENERIC = "很高兴见到你，%s！",		-- 物品名:"沃尔夫冈"->默认
            ATTACKER = "很高兴和你切磋...",		-- 物品名:"沃尔夫冈"
            MURDERER = "回头是岸！",		-- 物品名:"沃尔夫冈"
        ...
        WAXWELL =
        {
            ...
            ATTACKER = "你在使用危险的力量，不属于你的力量。",		-- 物品名:"麦斯威尔"
            MURDERER = "惋惜...",		-- 物品名:"麦斯威尔"
            REVIVER = "%s他把能力用在正义的事业。",		-- 物品名:"告密的心" 制造描述:"鬼魂朋友复活了，好可怕。"
            GHOST = "你渴望永生吗，%s。",		-- 物品名:"幽灵"
            FIRESTARTER = "%s只求火烤。",		-- 物品名:"麦斯威尔"
        },
        WX78 =
        {
            GENERIC = "你好，%s！",		-- 物品名:"WX-78"->默认
            ATTACKER = "%s，我在和机械练习拳脚...",		-- 物品名:"WX-78"
        ...
        WILLOW =
        {
            ...
            ATTACKER = "%s这并不光彩，但又必要...",		-- 物品名:"薇洛"
            MURDERER = "你见过三指了吗？%s。",		-- 物品名:"薇洛"
            REVIVER = "%s，鬼魂的朋友。",		-- 物品名:"告密的心" 制造描述:"鬼魂朋友复活了，好可怕。"
        ...
        WENDY =
        {
            ...
            ATTACKER = "%s，争斗并非我的本意。",		-- 物品名:"温蒂"
            MURDERER = "现在后悔还来得及！",		-- 物品名:"温蒂"
        ...
        WOODIE =
        {
            ...
            ATTACKER = "%s你渴望解脱吗...",		-- 物品名:"伍迪"
            MURDERER = "现在还来得及！",		-- 物品名:"伍迪"
        ...
        WATHGRITHR =
        {
            ...
            ATTACKER = "我会躲开%s的拳头。",		-- 物品名:"薇格弗德"
            MURDERER = "%s不要沉入斗争！",		-- 物品名:"薇格弗德"
            REVIVER = "%s精神饱满。",		-- 物品名:"告密的心" 制造描述:"鬼魂朋友复活了，好可怕。"
            GHOST = "这是武者的尽头吗，%s。",		-- 物品名:"幽灵"
        ...
        WINONA =
        {
            ...
            REVIVER = "你可真是好啊，%s。",		-- 物品名:"告密的心" 制造描述:"鬼魂朋友复活了，好可怕。"
        ...
        WORMWOOD =
        {
            GENERIC = "你好，格鲁特！",		-- 物品名:"沃姆伍德"->默认
            ATTACKER = "%s月亮会使人疯狂。",		-- 物品名:"沃姆伍德"
            MURDERER = "即使是植物也需要承担责任，%s!",		-- 物品名:"沃姆伍德"
            REVIVER = "%s从来不会放弃他的朋友。",		-- 物品名:"告密的心" 制造描述:"鬼魂朋友复活了，好可怕。"
            GHOST = "我以为你会在原地再长出来的...",		-- 物品名:"幽灵"
        ...
        WURT =
        {
            ...
            ATTACKER = "%s冷静下来……",		-- 物品名:"沃特"
            MURDERER = "这是用什么打的窝！",		-- 物品名:"沃特"
        ...
        WALTER =
        {
            ...
            ATTACKER = "我尽量让痛苦少一点？",		-- 物品名:"沃尔特"
            MURDERER = "你的那些故事开始反噬你了吗，%s？",		-- 物品名:"沃尔特"
        ...
        WANDA =
        {
            ...
            ATTACKER = "时间真的会改变人很多，%s！",		-- 物品名:"旺达"
            MURDERER = "我绝不会给你第二次机会的！",		-- 物品名:"旺达"
        ...
        WONKEY =
        {
            ...
            ATTACKER = "嘿，别像猴子一样胡闹了！",		-- 物品名:"芜猴"
            MURDERER = "它们发猴疯了！",		-- 物品名:"芜猴"
            REVIVER = "我的命居然是……猴子救的？",		-- 物品名:"告密的心" 制造描述:"鬼魂朋友复活了，好可怕。"
            GHOST = "那只猴子真吓人。",		-- 物品名:"幽灵"
            FIRESTARTER = "恐龙当时是不是就是这种感觉？",		-- 物品名:"芜猴"
        },
        MIGRATION_PORTAL =
        {
        },
		...
		MOLEHILL = "多么美好舒适的地洞啊！",		-- 物品名:"鼹鼠丘"
		MOLEHAT = "散发着讨厌的恶臭，但视野极佳。",		-- 物品名:"鼹鼠帽" 制造描述:"为穿戴者提供夜视能力。"
		EEL = "这能做一道好菜。",		-- 物品名:"鳗鱼"
		EEL_COOKED = "闻起来真香！",		-- 物品名:"熟鳗鱼"
        ...
        TOWNPORTAL =
        {
			GENERIC = "这个金字塔控制着沙子。",		-- 物品名:"懒人传送塔"->默认 制造描述:"用沙子的力量聚集你的朋友们。"
			ACTIVE = "准备好分离。",		-- 物品名:"懒人传送塔"->激活了 制造描述:"用沙子的力量聚集你的朋友们。"
		},
        TOWNPORTALTALISMAN =
        {
			GENERIC = "迷你分离器。",		-- 物品名:"沙之石"->默认
			ACTIVE = "也许步行更合适。",		-- 物品名:"沙之石"->激活了
		},
        ...
        MOONBASE =
        {
            ...
            BROKEN = "都搞砸了。",		-- 物品名:"月亮石"
            STAFFED = "然后？",		-- 物品名:"月亮石"
            WRONGSTAFF = "我想他应该放一个法杖？",		-- 物品名:"月亮石"->插错法杖
            MOONSTAFF = "石头神奇的点燃了它。",		-- 物品名:"月亮石"->已经插了法杖的（月杖）
        },
        MOONDIAL =
        {
			GENERIC = "水放大了月亮。",		-- 物品名:"月晷"->默认 制造描述:"追踪月相！"
		...
		RUINSHAT = "好像被我的角卡住了？",		-- 物品名:"铥矿皇冠" 制造描述:"附有远古力场！"
		NIGHTMARE_TIMEPIECE =
		{
		...
		BISHOP_NIGHTMARE = "分崩离析！",		-- 物品名:"损坏的发条主教"
		ROOK_NIGHTMARE = "强弩之末！",		-- 物品名:"损坏的发条战车"
		KNIGHT_NIGHTMARE = "残暴者！",		-- 物品名:"损坏的发条骑士"
		MINOTAUR = "他在守护什么。",		-- 物品名:"远古守护者"
		SPIDER_DROPPER = "小心头顶。",		-- 物品名:"穴居悬蛛"
		NIGHTMARELIGHT = "我想知道这个东西有什么用。",		-- 物品名:"梦魇灯座"
		NIGHTSTICK = "雷电！",		-- 物品名:"晨星锤" 制造描述:"用于夜间战斗的晨光。"
		GREENGEM = "绿色的石头。",		-- 物品名:"绿宝石"
		MULTITOOL_AXE_PICKAXE = "化繁为简！",		-- 物品名:"多用斧镐" 制造描述:"加倍实用。"
		ORANGESTAFF = "不可思议的。",		-- 物品名:"懒人魔杖" 制造描述:"适合那些不喜欢走路的人。"
		YELLOWAMULET = "手感温暖。",		-- 物品名:"魔光护符" 制造描述:"从天堂汲取力量。"
		GREENAMULET = "所有基地都得配一个！",		-- 物品名:"建造护符" 制造描述:"用更少的材料合成物品！"
		SLURPERPELT = "...",		-- 物品名:"铥矿徽章"->啜食者皮 制造描述:"跟踪周围魔力水平的流动。"
		SLURPER = "毛茸茸的！",		-- 物品名:"啜食者"
		SLURPER_PELT = "...",		-- 物品名:"啜食者皮"
		ARMORSLURPER = "一根湿漉漉的、帮助你抵抗饥饿的腰带。",		-- 物品名:"饥饿腰带" 制造描述:"保持肚子不饿。"
		ORANGEAMULET = "瞬移的用处可大了。",		-- 物品名:"懒人护符" 制造描述:"适合那些不喜欢捡东西的人。"
		YELLOWSTAFF = "星辰指引前路。",		-- 物品名:"唤星者魔杖" 制造描述:"召唤一个小星星。"
		YELLOWGEM = "这个宝石是黄色的。",		-- 物品名:"黄宝石"
		ORANGEGEM = "一颗橙宝石。",		-- 物品名:"橙宝石"
        OPALSTAFF = "呼唤。",		-- 物品名:"唤月者魔杖"
		...
		CAVE_BANANA = "软塌塌的。",		-- 物品名:"香蕉"
		CAVE_BANANA_COOKED = "好吃！",		-- 物品名:"熟香蕉"
        ...
        BAT = "他好像很有恶意",		-- 物品名:"洞穴蝙蝠"
        BATBAT = "真的会有这么大的蝙蝠吗。",		-- 物品名:"蝙蝠棒" 制造描述:"所有科技都如此...耗费精神。"
        BATWING = "那些东西即使死了都很讨厌。",		-- 物品名:"洞穴蝙蝠翅膀"
        BATWING_COOKED = "可以充饥。",		-- 物品名:"熟蝙蝠翅膀"
        BATCAVE = "不可打草惊蛇。",		-- 物品名:"蝙蝠洞"
        BEDROLL_FURRY = "真是又暖和又舒服。",		-- 物品名:"毛皮铺盖" 制造描述:"舒适地一觉睡到天亮！"
        BUNNYMAN = "危险的极端素食主义者。",		-- 物品名:"兔人"
        FLOWER_CAVE = "没见过的七一花朵。",		-- 物品名:"荧光花"
        GUANO = "另一种味道的粪便。",		-- 物品名:"鸟粪"
        LANTERN = "更文明的灯具。",		-- 物品名:"提灯" 制造描述:"可加燃料、明亮、便携！"
        LIGHTBULB = "奇怪，看起来就很好吃。",		-- 物品名:"荧光果"
        MANRABBIT_TAIL = "手里抓个东西挺好的。",		-- 物品名:"兔绒"
        MUSHROOMHAT = "让穿戴者看起来像一个有趣的家伙，不过我的角好像卡住了...",		-- 物品名:"蘑菇帽"
        MUSHROOM_LIGHT2 =
        {
            ON = "蓝色是悲伤的颜色。",		-- 物品名:"菌伞灯"->开启 制造描述:"受到火山岩浆灯饰学问的激发。"
            OFF = "我们可以用一些主要颜色来生成一个主要光源。",		-- 物品名:"菌伞灯"->关闭 制造描述:"受到火山岩浆灯饰学问的激发。"
            BURNT = "别有一番风味。",		-- 物品名:"菌伞灯"->烧焦的 制造描述:"受到火山岩浆灯饰学问的激发。"
        },
        MUSHROOM_LIGHT =
        {
            ON = "它点亮了。",		-- 物品名:"蘑菇灯"->开启 制造描述:"任何蘑菇的完美添加物。"
            OFF = "它是一个大蘑菇。",		-- 物品名:"蘑菇灯"->关闭 制造描述:"任何蘑菇的完美添加物。"
        ...
        TOADSTOOL =
        {
            GENERIC = "巨大不代表强大，我希望你清楚。",		-- 物品名:"毒菌蟾蜍"->默认
            RAGE = "冷静，青蛙！",		-- 物品名:"毒菌蟾蜍"->愤怒
        },
        MUSHROOMSPROUT =
        {
            GENERIC = "多么，好闻？",		-- 物品名:"孢子帽"->默认
        ...
        MUSHTREE_MEDIUM =
        {
            GENERIC = "为何会这么大。",		-- 物品名:"红蘑菇树"->默认
            BLOOM = "这个真是奇特。",		-- 物品名:"红蘑菇树"->蘑菇树繁殖？？
        },
        MUSHTREE_SMALL =
        {
        ...
        SLURTLE_SHELLPIECES = "拼不好的拼图。",		-- 物品名:"外壳碎片"
        SLURTLEHAT = "不知道能不能带上...",		-- 物品名:"背壳头盔"
        SLURTLEHOLE = "“恶心的”洞穴。",		-- 物品名:"蛞蝓龟窝"
        SLURTLESLIME = "会有用的。",		-- 物品名:"蛞蝓龟黏液"
        SNURTLE = "他不算太恶心，但还是恶心。",		-- 物品名:"蜗牛龟"
        SPIDER_HIDER = "哇！更多蜘蛛！",		-- 物品名:"洞穴蜘蛛"
        SPIDER_SPITTER = "招式的变化？",		-- 物品名:"喷射蜘蛛"
        ...
        TURF_BEARD_RUG = "我用我的胡须做的！",		-- 物品名:"胡须地毯" 制造描述:"有些人就是喜欢行为艺术。"
		POWCAKE = "尝尝看？",		-- 物品名:"芝士蛋糕"
        CAVE_ENTRANCE = "我在想那岩石能不能移开。",		-- 物品名:"被堵住的洞穴"
        CAVE_ENTRANCE_RUINS = "它有可能在隐瞒什么事情。",		-- 物品名:"被堵住的陷洞"->单机 洞二入口
       	CAVE_ENTRANCE_OPEN =
        {
            GENERIC = "大地本身在排斥我！",		-- 物品名:"洞穴"->默认
            OPEN = "当你凝视深渊的时候...",		-- 物品名:"洞穴"->打开
            FULL = "深渊也在凝视这你。",		-- 物品名:"洞穴"->满了
        },
        CAVE_EXIT =
        {
		...
		ADVENTURE_PORTAL = "看来是这个带我来到这的。",		-- 物品名:"麦斯威尔之门"->单机 麦斯威尔之门
		AMULET = "我想我用不着他。",		-- 物品名:"重生护符" 制造描述:"逃离死神的魔爪。"
		ANIMAL_TRACK = "猎物留下了足迹，远行开始存在意义。",		-- 物品名:"动物足迹"
		ARMORGRASS = "保护不多，但是够用。",		-- 物品名:"草甲" 制造描述:"提供少许防护。"
		ARMORMARBLE = "那看起来真的很沉。",		-- 物品名:"大理石甲" 制造描述:"它很重，但能够保护你。"
		ARMORWOOD = "那是一件非常合适的衣服。",		-- 物品名:"木甲" 制造描述:"为你抵御部分伤害。"
		ARMOR_SANITY = "来自地底的力量为我所用，我不知道是否合适。",		-- 物品名:"暗夜甲" 制造描述:"保护你的躯体，但无法保护你的心智。"
		ASH =
		{
			GENERIC = "经历过数年战争后的沙场，待风平浪静后\n就只剩灰烬。",		-- 物品名:"灰烬"->默认
		...
		AXE = "工欲善其事，必先利其器。",		-- 物品名:"斧头" 制造描述:"砍倒树木！"
		BABYBEEFALO =
		{
			GENERIC = "幼年时总是可爱的。",		-- 物品名:"小皮弗娄牛"->默认
		    SLEEPING = "做个好梦。",		-- 物品名:"小皮弗娄牛"->睡着了
        },
        BUNDLE = "我们的物资都在那里面！",		-- 物品名:"捆绑物资"
        BUNDLEWRAP = "把东西打包起来应该会容易搬一点。",		-- 物品名:"捆绑包装" 制造描述:"打包东西的必要工具。"
		BACKPACK = "你可以在那里面装进许多物品。",		-- 物品名:"背包" 制造描述:"携带更多物品。"
		BACONEGGS = "适合的早餐。",		-- 物品名:"培根煎蛋"
		BANDAGE = "似乎挺卫生的。",		-- 物品名:"蜂蜜药膏" 制造描述:"愈合小伤口。"
		BASALT = "太硬了，敲不碎！", --removed		-- 物品名:"玄武岩"
		BEARDHAIR = "看起来是谁丢在这的，说起来我也很少长胡子。",		-- 物品名:"胡须"
		BEARGER = "究竟是熊？还是獾？",		-- 物品名:"熊獾"
		BEARGERVEST = "温暖！",		-- 物品名:"熊皮背心" 制造描述:"像熊一样的背心。"
		ICEPACK = "毛皮使包内有保温效果。",		-- 物品名:"保鲜背包" 制造描述:"保持新鲜感。"
		BEARGER_FUR = "这样的毛皮可以可算是不小的收获。",		-- 物品名:"熊皮" 制造描述:"毛皮再生。"
		BEDROLL_STRAW = "看起来挺舒适，但闻起来一股霉味。",		-- 物品名:"草席卷" 制造描述:"一觉睡到天亮。"
		BEEQUEEN = "我不愿挑战你的权威，但也希望你不要“针”对我",		-- 物品名:"蜂王"
		BEEQUEENHIVE =
		{
        ...
        MINISIGN =
        {
            GENERIC = "夕妹一个会喜欢这个小东西的！",		-- 物品名:"小木牌"->默认
            UNDRAWN = "博士，合适的标记会很有帮助。",		-- 物品名:"小木牌"->没有画画
        },
		...
		BEEFALO =
		{
			...
			GENERIC = "是皮弗娄牛！",		-- 物品名:"皮弗娄牛"->默认
			NAKED = "呃，他很伤心。",		-- 物品名:"皮弗娄牛"->牛毛被刮干净了
			SLEEPING = "这些家伙睡得真是沉，\n想起我来也是许久未如此休息过了。",		-- 物品名:"皮弗娄牛"->睡着了
            DOMESTICATED = "这个没其他的那么臭。",		-- 物品名:"皮弗娄牛"->驯化牛
            ORNERY = "它看起来非常生气。",		-- 物品名:"皮弗娄牛"->战斗牛
            RIDER = "千里牛常有，伯乐不常有。",		-- 物品名:"皮弗娄牛"->骑行牛
            PUDGY = "嗯，它需要一些锻炼。",		-- 物品名:"皮弗娄牛"->胖牛
            MYPARTNER = "我们永远都是战友。",		-- 物品名:"皮弗娄牛"
		},
		BEEFALOHAT = "如果戴起来我就会有两对角...",		-- 物品名:"牛角帽" 制造描述:"成为牛群中的一员！连气味也变得一样。"
		BEEFALOWOOL = "闻起来像皮弗娄牛的眼泪。",		-- 物品名:"牛毛"
		BEEHAT = "保护你的皮肤。",		-- 物品名:"养蜂帽" 制造描述:"防止被愤怒的蜜蜂蜇伤。"
		...
		BIRD_EGG = "鸟蛋中孕育的生命，他会思考自我的存在吗。",		-- 物品名:"鸟蛋"
		BIRD_EGG_COOKED = "吃起来不错！",		-- 物品名:"熟鸟蛋"
		BISHOP = "退后，传教士！",		-- 物品名:"发条主教"
		BLOWDART_FIRE = "这东西似乎根本不安全。",		-- 物品名:"火焰吹箭" 制造描述:"向你的敌人喷火。"
		BLOWDART_SLEEP = "这东西可以用来奇袭。",		-- 物品名:"催眠吹箭" 制造描述:"催眠你的敌人。"
		BLOWDART_PIPE = "由暗器取得的胜利可不光彩，\n但兵不厌诈。",		-- 物品名:"吹箭" 制造描述:"向你的敌人喷射利齿。"
		BLOWDART_YELLOW = "它的准确性令人震惊。",		-- 物品名:"雷电吹箭" 制造描述:"朝你的敌人放闪电。"
		BLUEAMULET = "像冰一样冷！",		-- 物品名:"寒冰护符" 制造描述:"多么冰冷酷炫的护符。"
		BLUEGEM = "它散发着冰冷能量的光芒。",		-- 物品名:"蓝宝石"
		BLUEPRINT =
		{
            COMMON = "和周围的东西不是一个风格的...",		-- 物品名:"蓝图"
            RARE = "已经见怪不怪了...",		-- 物品名:"蓝图"->罕见的
        },
        SKETCH = "一张雕像的图片。要找个地方才能做出来。",		-- 物品名:"{item}草图"
		COOKINGRECIPECARD = 
		{
			GENERIC = "我实在破译不了这些笔迹。",		-- 物品名:"{item}食谱卡"->默认
		},
		...
		BOARDS = "也许我们可能用这个建立防御。",		-- 物品名:"木板" 制造描述:"更平直的木头。"
		BONESHARD = "骨头？我们需要谨慎起来。",		-- 物品名:"骨头碎片"
		BONESTEW = "适量的佳肴可以提振军心，\n现在用来享受也是不错的。",		-- 物品名:"炖肉汤"
		BUGNET = "很有童趣的东西。",		-- 物品名:"捕虫网" 制造描述:"抓虫子用的。"
		BUSHHAT = "看着有点扎人。",		-- 物品名:"灌木丛帽" 制造描述:"很好的伪装！"
		BUTTER = "不会飞的蝴蝶...",		-- 物品名:"黄油"
		BUTTERFLY =
		{
		...
		BUTTERFLYWINGS = "憔悴损。",		-- 物品名:"蝴蝶翅膀"
		BUZZARD = "战后的天空上总是有他们徘徊。",		-- 物品名:"秃鹫"
		...
		CAMPFIRE =
		{
			...
			HIGH = "火焰过高了，添柴应该细水长流！",		-- 物品名:"营火"->高 制造描述:"燃烧时发出光亮。"
			LOW = "火变得有点小了。",		-- 物品名:"营火"->低？ 制造描述:"燃烧时发出光亮。"
			NORMAL = "真舒服，\n不如，温一杯酒来饮？。",		-- 物品名:"营火"->普通 制造描述:"燃烧时发出光亮。"
			OUT = "哦，火灭了。",		-- 物品名:"营火"->出去？外面？ 制造描述:"燃烧时发出光亮。"
		},
		CANE = "我还没老到需要手杖。",		-- 物品名:"步行手杖" 制造描述:"泰然自若地快步走。"
		...
		CARROT = "生吃也是不错的。",		-- 物品名:"胡萝卜"
		CARROT_COOKED = "软塌塌的。",		-- 物品名:"烤胡萝卜"
		CARROT_PLANTED = "凭空产生的？",		-- 物品名:"胡萝卜"
		CARROT_SEEDS = "这是一颗胡萝卜种子。",		-- 物品名:"椭圆形种子"
		CARTOGRAPHYDESK =
		{
		...
		WATERMELON_SEEDS = "这是一颗蕨类植物的种子。",		-- 物品名:"方形种子"
		...
		CHESTER = "他好像再说：“你是我的眼...”",		-- 物品名:"切斯特"
		CHESTER_EYEBONE =
		{
			GENERIC = "如果我让他叼着这个骨眼，他是不是就能自由行动了...",		-- 物品名:"眼骨"->默认
			WAITING = "默哀。",		-- 物品名:"眼骨"->需要等待
		},
		COOKEDMANDRAKE = "可怜的小家伙。",		-- 物品名:"熟曼德拉草"
		COOKEDMEAT = "碳烤熟透。",		-- 物品名:"熟肉"
		COOKEDMONSTERMEAT = "只比生吃的时候好吃一点点。",		-- 物品名:"熟怪物肉"
		COOKEDSMALLMEAT = "现在我不必担心会生虫子了！",		-- 物品名:"熟小肉"
		COOKPOT =
		{
			COOKING_LONG = "心急吃不了热豆腐。",		-- 物品名:"烹饪锅"->饭还需要很久 制造描述:"制作更好的食物。"
			COOKING_SHORT = "收拾餐桌，准备吃饭。",		-- 物品名:"烹饪锅"->饭快做好了 制造描述:"制作更好的食物。"
			DONE = "嗯！可以吃了！",		-- 物品名:"烹饪锅"->完成了 制造描述:"制作更好的食物。"
			EMPTY = "看着都觉得饿。",		-- 物品名:"烹饪锅" 制造描述:"制作更好的食物。"
			BURNT = "这是什么菜（",		-- 物品名:"烹饪锅"->烧焦的 制造描述:"制作更好的食物。"
		},
		CORN = "玉米",		-- 物品名:"玉米"
		CORN_COOKED = "吃完后要记得的锻炼！",		-- 物品名:"爆米花"
		CORN_SEEDS = "这是一颗种子。",		-- 物品名:"簇状种子"
        CANARY =
		{
			GENERIC = "小家伙，你会唱歌吗？",		-- 物品名:"金丝雀"->默认
			HELD = "我不喜欢溜鸟。",		-- 物品名:"金丝雀"->拿在手里
		},
        CANARY_POISONED = "看起来不妙。",		-- 物品名:"金丝雀（中毒）"
		CRITTERLAB = "那里面有什么东西吗？",		-- 物品名:"岩石巢穴"
        CRITTER_GLOMLING = "挺可爱的！",		-- 物品名:"小格罗姆"
        CRITTER_DRAGONLING = "你也会喷火吗？",		-- 物品名:"小龙蝇"
		CRITTER_LAMB = "比起它妈妈，它的粘液少多了。",		-- 物品名:"小钢羊"
        CRITTER_PUPPY = "对一只小怪兽来说真是太可爱了！",		-- 物品名:"小座狼"
        CRITTER_KITTEN = "你会成为一位很棒的陪练。",		-- 物品名:"浣猫崽"
        CRITTER_PERDLING = "我的长羽毛的朋友。",		-- 物品名:"小火鸡"
		CRITTER_LUNARMOTHLING = "我希望他不要往火堆中冲。",		-- 物品名:"小蛾子"
		CROW =
		{
			GENERIC = "我好像听见有人说\n“众神之父赐予我视野”",		-- 物品名:"乌鸦"->默认
		...
		CUTSTONE = "没块砖都有他自己的用处。",		-- 物品名:"石砖" 制造描述:"切成正方形的石头。"
        ...
        ANTLIONHAT = "这是一项破土而出的科学成就。",		-- 物品名:"刮地皮头盔" 制造描述:"旧地不去，新地不来。"
		...
		FISHINGROD = "钩子、鱼线和棍子！",		-- 物品名:"淡水钓竿" 制造描述:"去钓鱼。为了鱼。"
        ...
        FOSSIL_PIECE = "我们应该把它们一起放回去。",		-- 物品名:"化石碎片"
        FOSSIL_STALKER =
        {
			GENERIC = "还有些碎片没找到。",		-- 物品名:"奇异的骨架"->默认
			FUNNY = "我的直觉告诉我这有点不对。",		-- 物品名:"奇异的骨架"->趣味？？
		...
		ARROWSIGN_POST =
		{
			GENERIC = "它说“那个方向”。",		-- 物品名:"指路木牌"->默认 制造描述:"对这个世界指指点点。或许只是打下手势。"
		...
		LIVINGLOG = "它看着有点着急。",		-- 物品名:"活木头" 制造描述:"投身制作，置身其中。"
		LOG =
		{
        ...
        PETALS_EVIL = "我不确定我想拿这些。",		-- 物品名:"深色花瓣"
        ...
        PLANTMEAT_COOKED = "至少它现在是热的。",		-- 物品名:"熟叶肉"
        PLANT_NORMAL =
        {
        ...
        HALLOWEENCANDY_10 = "只有傻瓜才不会爱上这东西。",		-- 物品名:"触手棒棒糖"
		...
		HALLOWEEN_ORNAMENT_5 = "八只手的装饰。",		-- 物品名:"穴居悬蛛装饰"
        ...
        FIRECRACKERS = "充满爆炸科学。",		-- 物品名:"红鞭炮" 制造描述:"用爆炸来庆祝！"
		...
		YOTP_FOOD1 = "一场适合我的盛宴。",		-- 物品名:"贡品烤肉" 制造描述:"向猪王敬肉。"
        ...
        YOTB_BEEFALOSHRINE =
        {
            ...
            EMPTY = "嗯……皮弗娄牛是什么做的呢？",		-- 物品名:"皮弗娄牛神龛" 制造描述:"供奉坚毅之皮弗娄牛。"
        ...
        WINTER_TREE =
        {
            ...
            BURNING = "我认为那是个错误。",		-- 物品名:"冬季盛宴树"->正在燃烧
            CANDECORATE = "冬季盛宴快乐！",		-- 物品名:"冬季盛宴树"->烛台？？？
            YOUNG = "马上就到冬季盛宴了！",		-- 物品名:"冬季盛宴树"->还年轻
        },
		WINTER_TREESTAND =
		{
			GENERIC = "我需要一颗松果。",		-- 物品名:"盛宴树盆"->默认 制造描述:"种植并装饰一棵冬季盛宴树！"
        ...
        WINTER_FOOD5 = "能有一次吃浆果以外的东西真是好。", --yule log cake		-- 物品名:"巧克力原木蛋糕"
		...
		WINTERSFEASTOVEN =
		{
			...
			COOKING = "烹饪果然是科学。",		-- 物品名:"砖砌烤炉"->无效 制造描述:"燃起了喜庆的火焰。"
		...
		HUMANMEAT_COOKED = "煮的粉嫩，但在道德上还是灰色地带。",		-- 物品名:"熟长猪"
        ...
        TRAP_BRAMBLE = "谁要是踩上去肯定会被戳到。",		-- 物品名:"荆棘陷阱" 制造描述:"中招机会平等的扰人陷阱。"
        ...
        WALKINGPLANK_GRASS = "我们就不能造一艘救生船吗？",		-- 物品名:"木板"
        ...
        FISHMEAT_SMALL_COOKED = "一点点熟鱼肉。",		-- 物品名:"熟小鱼块"
        ...
        HERMITHOUSE =
	{
        ...
        HERMITCRAB = "见到你真高兴，美丽的女士。",		-- 物品名:"寄居蟹隐士"
        HERMIT_PEARL = "真是美丽。",		-- 物品名:"珍珠的珍珠"
        HERMIT_CRACKED_PEARL = "有人会伤心，别让她看见。",		-- 物品名:"开裂珍珠"
        WATERPLANT = "别惹恼他们。",		-- 物品名:"海草"
        WATERPLANT_BOMB = "海胆吗？",		-- 物品名:"种壳"
        WATERPLANT_BABY = "勃勃生机 万物竟发的时候。",		-- 物品名:"海芽"
        WATERPLANT_PLANTER = "他的故乡属于大海。",		-- 物品名:"海芽插穗"
        SHARK = "他真生猛",		-- 物品名:"岩石大白鲨"
        MASTUPGRADE_LAMP_ITEM = "让我想起帮兄弟们守夜的时候。",		-- 物品名:"甲板照明灯" 制造描述:"桅杆照明附件。"
        MASTUPGRADE_LIGHTNINGROD_ITEM = "我已经驾驭了陆{{【上和海上的电力！",		-- 物品名:"避雷导线" 制造描述:"为你的桅杆带来过电般的刺激。"
        WATERPUMP = "那位可爱的扎拉克这样就应该放心了。",		-- 物品名:"消防泵" 制造描述:"水水水，到处都是水！"
        BARNACLE = "要吃前最好加热一下，生吃非常容易拉肚子。",		-- 物品名:"藤壶"
        BARNACLE_COOKED = "非常鲜美。",		-- 物品名:"熟藤壶"
        BARNACLEPITA = "方便好做，不错的美味。",		-- 物品名:"藤壶皮塔饼"
        BARNACLESUSHI = "我喜欢里面的煎蛋",		-- 物品名:"藤壶握寿司"
        BARNACLINGUINE = "非常顶！",		-- 物品名:"藤壶中细面"
        BARNACLESTUFFEDFISHHEAD = "很有哥伦比亚的风格的美食。",		-- 物品名:"酿鱼头"
        LEAFLOAF = "很耐储存。",		-- 物品名:"叶肉糕"
        LEAFYMEATBURGER = "年去逛街的时候会点这个。",		-- 物品名:"素食堡"
        LEAFYMEATSOUFFLE = "糖总是让人心情愉悦。",		-- 物品名:"果冻沙拉"
        MEATYSALAD = "恐怖的分量。",		-- 物品名:"牛肉绿叶菜"
		MOLEBAT = "如果这个小家伙不招惹我就更可爱了。",		-- 物品名:"裸鼹蝠"
        MOLEBATHILL = "里面有他的宝藏",		-- 物品名:"裸鼹蝠丘"
        BATNOSE = "有人知道这是谁的鼻子吗？",		-- 物品名:"裸露鼻孔"
        BATNOSE_COOKED = "出来的时候，闻到的是鼻子的味道。",		-- 物品名:"炭烤鼻孔"
        BATNOSEHAT = "这太...有想象力了...",		-- 物品名:"牛奶帽"
        MUSHGNOME = "有兴趣和我下棋吗先生？",		-- 物品名:"蘑菇地精"
        SPORE_MOON = "这位先生可能不太高兴。",		-- 物品名:"月亮孢子"
        MOON_CAP = "来历不明的蘑菇最好不要吃。",		-- 物品名:"月亮蘑菇"
        MOON_CAP_COOKED = "这是勇敢的尝试。",		-- 物品名:"熟月亮蘑菇"
        MUSHTREE_MOON = "这颗蘑菇树明显跟其他的有异。",		-- 物品名:"月亮蘑菇树"
        LIGHTFLIER = "真是奇怪，装在我的口袋里居然还能发光！",		-- 物品名:"球状光虫"
        GROTTO_POOL_BIG = "这里居然有玻璃，太神奇了。",		-- 物品名:"玻璃绿洲"
        GROTTO_POOL_SMALL = "这里居然有玻璃，太神奇了。",		-- 物品名:"小玻璃绿洲"
        DUSTMOTH = "真是些整齐的小家伙，不是吗？",		-- 物品名:"尘蛾"
        DUSTMOTHDEN = "它们在里面过得很舒服。",		-- 物品名:"整洁洞穴"
        ARCHIVE_LOCKBOX = "打不开，想想其他办法吧。",		-- 物品名:"蒸馏的知识"
        ARCHIVE_CENTIPEDE = "他在保护着什么。",		-- 物品名:"远古哨兵蜈蚣"
        ARCHIVE_CENTIPEDE_HUSK = "好好休息吧。",		-- 物品名:"哨兵蜈蚣壳"
        ARCHIVE_COOKPOT =
        {
            COOKING_LONG = "走去做点别的怎么样。",		-- 物品名:"远古窑"->饭还需要很久
            COOKING_SHORT = "稍安勿躁。",		-- 物品名:"远古窑"->饭快做好了
            DONE = "嗯！可以吃了！",		-- 物品名:"远古窑"->完成了
            EMPTY = "把上面的灰尘先抖干净，怎么样？",		-- 物品名:"远古窑"
            BURNT = "下次要小心了。",		-- 物品名:"远古窑"->烧焦的
        },
        ARCHIVE_MOON_STATUE = "暂伴月将影，行乐需及春。",		-- 物品名:"远古月亮雕像"
        ARCHIVE_RUNE_STATUE =
        {
        ...
        ARCHIVE_RESONATOR =
	{
            GENERIC = "小 小帮手 立大功。",		-- 物品名:"星象探测仪"->默认
            IDLE = "它似乎找到了值得被找到的东西。",		-- 物品名:"星象探测仪"
        },
        ARCHIVE_RESONATOR_ITEM = "迟迟钟鼓初长夜，耿耿星河欲曙天。",		-- 物品名:"星象探测仪" 制造描述:"它会出土什么秘密呢？"
        ARCHIVE_LOCKBOX_DISPENCER =
	{
          POWEROFF = "好像没电了。",		-- 物品名:"知识饮水机"
          GENERIC =  "我有一种强烈的冲动，想站在它的周围侃侃而谈。",		-- 物品名:"知识饮水机"->默认
        },
        ARCHIVE_SECURITY_DESK =
	{
            POWEROFF = "找东西修一下吧。",		-- 物品名:"远古哨所"
            GENERIC = "它想亲近我。",		-- 物品名:"远古哨所"->默认
        },
        ARCHIVE_SECURITY_PULSE = "你这是要上哪去？是个有意思的地方吗？",		-- 物品名:"远古哨所"
        ARCHIVE_SWITCH =
	{
            VALID = "竟然是以宝石为能源。",		-- 物品名:"华丽基座"->有效
        ...
        ARCHIVE_PORTAL =
	{
        ...
        WATERINGCAN =
        {
            GENERIC = "生命需要水分。",		-- 物品名:"空浇水壶"->默认 制造描述:"让植物保持快乐和水分。"
            EMPTY = "我们去青蛙的地盘要点东西吧。",		-- 物品名:"空浇水壶" 制造描述:"让植物保持快乐和水分。"
        },
        PREMIUMWATERINGCAN =
        {
            GENERIC = "不得不说，他真大。",		-- 物品名:"空鸟嘴壶"->默认 制造描述:"灌溉方面的创新!"
            EMPTY = "希望还能给青蛙们留点水。",		-- 物品名:"空鸟嘴壶" 制造描述:"灌溉方面的创新!"
        },
		FARM_PLOW = "开荒南野际，守拙归田园。",		-- 物品名:"耕地机"
		FARM_PLOW_ITEM = "暖暖远人村，依依墟里烟。",		-- 物品名:"耕地机" 制造描述:"为你的植物犁一块地。"
		FARM_HOE = "一分耕耘，一分收获。",		-- 物品名:"园艺锄" 制造描述:"翻耕，为撒播农作物做准备。"
		GOLDEN_FARM_HOE = "皇帝的锄头。",		-- 物品名:"黄金园艺锄" 制造描述:"优雅地耕地。"
		NUTRIENTSGOGGLESHAT = "植物也需要好好吃饭。",		-- 物品名:"高级耕作先驱帽" 制造描述:"让你看到一个成功的花园。"
		PLANTREGISTRYHAT = "去了解植物朋友们。",		-- 物品名:"耕作先驱帽" 制造描述:"让你的园艺专业知识得到增长。"
        FARM_SOIL_DEBRIS = "你长错了地方。",		-- 物品名:"农田杂物"
		FIRENETTLES = "冬天没有棉袄的时候，可以试试。",		-- 物品名:"火荨麻叶"
		FORGETMELOTS = "惜花须自爱，休只为花疼。",		-- 物品名:"必忘我"
		SWEETTEA = "心旷神怡。",		-- 物品名:"舒缓茶"
		TILLWEED = "谢谢你的好意，我自己可以打理好园子。",		-- 物品名:"犁地草"
		TILLWEEDSALVE = "我的救赎。",		-- 物品名:"犁地草膏" 制造描述:"慢慢去处病痛。"
        WEED_IVY = "美丽又危险。",		-- 物品名:"刺针旋花"
        IVY_SNARE = "我们之间没有更和平的手段了吗？",		-- 物品名:"缠绕根须"
		TROPHYSCALE_OVERSIZEDVEGGIES =
		{
			GENERIC = "看看谁是重量级。",		-- 物品名:"农产品秤"->默认 制造描述:"称量你珍贵的水果和蔬菜。"
			HAS_ITEM = "重量: {weight}\n收获日: {day}\n不赖。",		-- 物品名:"农产品秤" 制造描述:"称量你珍贵的水果和蔬菜。"
			HAS_ITEM_HEAVY = "重量: {weight}\n收获日: {day}\n谁能想到会长这么大？",		-- 物品名:"农产品秤" 制造描述:"称量你珍贵的水果和蔬菜。"
            HAS_ITEM_LIGHT = "成功走完一生，也是大功一件。",		-- 物品名:"农产品秤" 制造描述:"称量你珍贵的水果和蔬菜。"
			BURNING = "没想到你还有锅的用途。",		-- 物品名:"农产品秤"->正在燃烧 制造描述:"称量你珍贵的水果和蔬菜。"
        ...
        VEGGIE_OVERSIZED_ROTTEN = "尘归尘，土归土。",		-- 物品名:"农产品秤" 制造描述:"称量你珍贵的水果和蔬菜。"
		FARM_PLANT =
		{
			GENERIC = "那是一株植物！",		-- 物品名:未找到
			SEED = "现在等着就好了。",		-- 物品名:未找到
			GROWING = "今天也努力了，辛苦了。",		-- 物品名:未找到
			FULL = "是时候收获科学的成果了。",		-- 物品名:未找到
			ROTTEN = "可惜啊！要是在成熟的时候收割就好了!",		-- 物品名:未找到
			FULL_OVERSIZED = "连黍都会倾佩我的成果。",		-- 物品名:未找到
			ROTTEN_OVERSIZED = "尘归尘，土归土。",		-- 物品名:未找到
			FULL_WEED = "良莠不齐，生命已然是奇迹。",		-- 物品名:未找到
			BURNING = "这对植物来说不是好事……",		-- 物品名:未找到
		},
        FRUITFLY = "聒噪。",		-- 物品名:"果蝇"
        LORDFRUITFLY = "请你离开，谢谢。",		-- 物品名:"果蝇王"
        FRIENDLYFRUITFLY = "要不我们比比谁更快。",		-- 物品名:"友好果蝇"
        FRUITFLYFRUIT = "我们去一个与世无争的地方吧。",		-- 物品名:"友好果蝇果"
        SEEDPOUCH = "术业有专攻。",		-- 物品名:"种子袋" 制造描述:"妥善保管好种子。"
		CARNIVAL_HOST = "健谈的朋友。",		-- 物品名:"良羽鸦"
		CARNIVAL_CROWKID = "你好小家伙。",		-- 物品名:"小乌鸦"
		...
		CARNIVALCANNON_KIT = "我在把东西弄炸】】】】】】】】】】】】】】】】】】】】】】方面积累了丰富的经验。",		-- 物品名:"奖品摊位"
		CARNIVALCANNON =
		{
		...
		CARNIVALDECOR_BANNER_KIT = "我必须自己建造它？我早该料到的。",		-- 物品名:"光线捕捉器套装" 制造描述:"枝头挂着闪光的小饰品。"
        ...
        CARNIVAL_VEST_A = "这让我看起来很有冒险精神。",		-- 物品名:"叽啾啾喳围巾" 制造描述:"用捡来的树叶做成的异想天开的围巾。"
        CARNIVAL_VEST_B = "就像穿上了自己专属的树荫。",		-- 物品名:"叽啾啾喳斗篷" 制造描述:"这东西确实值得称道。"
        CARNIVAL_VEST_C = "希望这里头没虫子……",		-- 物品名:"叽啾啾喳小披肩" 制造描述:"鸦年华游客的必备小披肩。"
	...
	{
            GENERIC = "科学的配方使其具有最大的可拥抱性。",		-- 物品名:"幸运兽弗娄牛玩偶"->默认
            YOTB = "不知道裁判会怎么说？",		-- 物品名:"幸运兽弗娄牛玩偶"
        },
        ...
        BEAST_BLUEPRINT = "我觉得我要走运了！",		-- 物品名:"幸运兽礼服款式"
		...
		TICOON =
		{
			...
			ABANDONED = "我一定能靠自己找到它们。",		-- 物品名:"大虎"
			SUCCESS = "嘿，他找到了一个！",		-- 物品名:"大虎"
			LOST_TRACK = "有人先发现了它们。",		-- 物品名:"大虎"
			NEARBY = "看起来附近有东西。",		-- 物品名:"大虎"
			TRACKING = "我应该紧跟他的步伐。",		-- 物品名:"大虎"
			TRACKING_NOT_MINE = "他在为别人引路。",		-- 物品名:"大虎"
		...
		KITCOON_MARSH = "我必须多收集点……做研究！",		-- 物品名:"小浣猫"
		KITCOON_DECIDUOUS = "你就是最可爱的小猫咪！",		-- 物品名:"小浣猫"
		KITCOON_GRASS = "你就是最可爱的小猫咪！",		-- 物品名:"小浣猫"
		KITCOON_ROCKY = "我必须多收集点……做研究！",		-- 物品名:"小浣猫"
		KITCOON_DESERT = "我必须多收集点……做研究！",		-- 物品名:"小浣猫"
		KITCOON_MOON = "我必须多收集点……做研究！",		-- 物品名:"小浣猫"
		KITCOON_YOT = "我必须多收集点……做研究！",		-- 物品名:"小浣猫"
        ...
        ALTERGUARDIAN_PHASE2 =
	{
        ...
        ALTERGUARDIANHATSHARD = "连部件都如此光彩夺目！",		-- 物品名:"启迪碎片"
        MOONSTORM_GLASS =
	{
        ...
        WAGSTAFF_NPC = "不论你是谁，但是你似乎需要我的帮助！",		-- 物品名:"颗粒状传输"
        WAGSTAFF_NPC_MUTATIONS = "没理由停下来！",		-- 物品名:"颗粒状传输"
        ...
        WAGSTAFF_TOOL_4 = "我的本能告诉我，这就是我一直在寻找的工具！",		-- 物品名:"概念刷洗器"
        WAGSTAFF_TOOL_5 = "这是什么。",		-- 物品名:"校准观察机"
        MOONSTORM_GOGGLESHAT = "对啊！结合月亮与土豆能量，我为什么没有早点想到呢？",		-- 物品名:"星象护目镜" 制造描述:"利用土豆之眼来看清风暴。"
        MOON_DEVICE =
	{
        ...
        POCKETWATCH_PORTAL =
	{
        ...
        POCKETWATCH_WEAPON =
	{
			GENERIC = "坏事发生只是时间问题。",		-- 物品名:"警钟"->默认 制造描述:"这只钟敲的就是你。"
        ...
        TERRARIUM =
	{
            GENERIC = "看着它让我的头感觉很模糊，好像有很多小方块。",		-- 物品名:"盒中泰拉"->默认
            CRIMSON = "我有种不好的预感……",		-- 物品名:"盒中泰拉"
            ENABLED = "我到了彩虹的另一边了吗？！",		-- 物品名:"盒中泰拉"
			WAITING_FOR_DARK = "会是什么呢？不然睡一觉起来再看。",		-- 物品名:"盒中泰拉"
			COOLDOWN = "这之后需要冷却一下。",		-- 物品名:"盒中泰拉"->冷却中
			SPAWN_DISABLED = "我应该不会再被窥视的目光所打扰了。",		-- 物品名:"盒中泰拉"
        },
        MIGHTY_GYM =
        {
            GENERIC = "我光是看它一眼就感觉肌肉拉伤了……",		-- 物品名:"强大健身房"->默认 制造描述:"拿出力量来吧！"
            BURNT = "再也不会让谁肌肉拉伤了。",		-- 物品名:"强大健身房"->烧焦的 制造描述:"拿出力量来吧！"
        },
        DUMBBELL = "我做脑力训练比较多。",		-- 物品名:"哑铃" 制造描述:"练肌肉离不开棍棒和石头。"
        DUMBBELL_GOLDEN = "精诚所至，金石为开。",		-- 物品名:"黄金哑铃" 制造描述:"举重的黄金标准。"
		DUMBBELL_MARBLE = "我已经把我的大脑锻炼成了我身上最强壮的肌肉。",		-- 物品名:"大理石哑铃" 制造描述:"获得有棱有角体格的捷径。"
        DUMBBELL_GEM = "这点重量，我轻松就能征服——啊！我的脊柱！！",		-- 物品名:"宝石哑铃" 制造描述:"让你锻炼的方方面面都得到打磨。"
        POTATOSACK = "不是装满了土豆形状的石头，就是石头形状的土豆。",		-- 物品名:"土豆袋" 制造描述:"马铃薯的天然栖息地。"
        DUMBBELL_HEAT = "用来热身还不错。",		-- 物品名:"热铃" 制造描述:"进行终极热身。"
        DUMBBELL_REDGEM = "我确实感受到肌肉在燃烧。",		-- 物品名:"火铃" 制造描述:"感受燃烧！"
        DUMBBELL_BLUEGEM = "没有比这更酷的了。",		-- 物品名:"冰铃" 制造描述:"冰封妨碍锻炼的东西。"
        TERRARIUMCHEST =
		{
			GENERIC = "没有谁因为偷看盒子里的东西而出事吧？",		-- 物品名:"显眼箱子"->默认
			BURNT = "它不会再打扰任何人了。",		-- 物品名:"显眼箱子"->烧焦的
			SHIMMER = "那个看起来有点格格不入……",		-- 物品名:"显眼箱子"
		},
		EYEMASKHAT = "不得不说，我独具慧眼。",		-- 物品名:"眼面具"
        EYEOFTERROR = "瞄准眼睛！",		-- 物品名:"恐怖之眼"
        EYEOFTERROR_MINI = "我开始觉得不自在了。",		-- 物品名:"可疑窥视者"
		...
		COTL_TRINKET = "这是多么了不起的成就啊。",		-- 物品名:"红眼冠"
		TURF_COTL_GOLD = "别踩在那上面，那个很贵的！",		-- 物品名:"黄金地板" 制造描述:"为新的黄金时代奠定基础。"
		TURF_COTL_BRICK = "砖块是地板的组成部分。",		-- 物品名:"砖地板" 制造描述:"单独的砖块聚集在一起用于更大的目的。"
		COTL_TABERNACLE_LEVEL1 =
		{
			LIT = "多么舒缓的光啊。",		-- 物品名:"低微咩咩雕像" 制造描述:"劣质的咩咩雕刻品。"
			GENERIC = "需要燃料。",		-- 物品名:"低微咩咩雕像"->默认 制造描述:"劣质的咩咩雕刻品。"
		},
		COTL_TABERNACLE_LEVEL2 =
		{
			LIT = "多么鼓舞人心的雕塑啊！",		-- 物品名:"有所改进咩咩雕像" 制造描述:"一座用来歌颂咩咩的精致雕像。"
			GENERIC = "需要燃料。",		-- 物品名:"有所改进咩咩雕像"->默认 制造描述:"一座用来歌颂咩咩的精致雕像。"
		},
		COTL_TABERNACLE_LEVEL3 =
		{
			LIT = "我可以永远盯着它……永远……",		-- 物品名:"完美无瑕咩咩雕像" 制造描述:"一座纪念咩咩荣耀的耀眼纪念碑。"
			GENERIC = "需要燃料。",		-- 物品名:"完美无瑕咩咩雕像"->默认 制造描述:"一座纪念咩咩荣耀的耀眼纪念碑。"
		},
        CATTOY_MOUSE = "给老鼠都安上轮子了，科学家们接下来还会想出什么呢？",		-- 物品名:"发条鼠玩具" 制造描述:"开始一场猫鼠游戏。"
        KITCOON_NAMETAG = "我应该想几个名字！叫什么呢，小威尔逊，小威尔逊2号……",		-- 物品名:"小浣猫项圈" 制造描述:"给可爱的小脸蛋起个名字。"
		KITCOONDECOR1 =
        {
		...
		KITCOONDECOR2 =
        {
            ...
            BURNT = "它给烧了。",		-- 物品名:"逗猫小鱼"->烧焦的
        },
		KITCOONDECOR1_KIT = "看起来需要组装一下。",		-- 物品名:"火鸡不倒翁套装" 制造描述:"属于猫科朋友的羽毛乐趣。"
		KITCOONDECOR2_KIT = "看起来不是很难制作。",		-- 物品名:"逗猫小鱼套装" 制造描述:"一场愉快的无用功。"
        WX78MODULE_MAXHEALTH = "一个小玩意竟然装得下这么多的科学知识。",		-- 物品名:"强化电路" 制造描述:"让你的机械身躯更加健壮。"
        WX78MODULE_MAXSANITY1 = "一个小玩意竟然装得下这么多的科学知识。",		-- 物品名:"处理器电路" 制造描述:"一点额外的处理能力有助于缓解机械思维。"
        WX78MODULE_MAXSANITY = "一个小玩意竟然装得下这么多的科学知识。",		-- 物品名:"超级处理器电路" 制造描述:"处理能力的大幅提升将让齿轮高速转动。"
        WX78MODULE_MOVESPEED = "一个小玩意竟然装得下这么多的科学知识。",		-- 物品名:"加速电路" 制造描述:"匆忙设计的加速器。亟待改进。"
        WX78MODULE_MOVESPEED2 = "一个小玩意竟然装得下这么多的科学知识。",		-- 物品名:"超级加速电路" 制造描述:"一个完美的加速器，将你的引擎提到最高档。"
        WX78MODULE_HEAT = "一个小玩意竟然装得下这么多的科学知识。",		-- 物品名:"热能电路" 制造描述:"要热起来了。"
        WX78MODULE_NIGHTVISION = "一个小玩意竟然装得下这么多的科学知识。",		-- 物品名:"光电电路" 制造描述:"将你的光学传感器调校为夜视效果。"
        WX78MODULE_COLD = "一个小玩意竟然装得下这么多的科学知识。",		-- 物品名:"制冷电路" 制造描述:"把你的底盘变成一个便携式冰柜。"
        WX78MODULE_TASER = "一个小玩意竟然装得下这么多的科学知识。",		-- 物品名:"电气化电路" 制造描述:"谁敢惹你就等着被电击吧。"
        WX78MODULE_LIGHT = "一个小玩意竟然装得下这么多的科学知识。",		-- 物品名:"照明电路" 制造描述:"用你的存在照亮一个房间。"
        WX78MODULE_MAXHUNGER1 = "一个小玩意竟然装得下这么多的科学知识。",		-- 物品名:"胃增益电路" 制造描述:"增加一点燃料箱的容量。"
        WX78MODULE_MAXHUNGER = "一个小玩意竟然装得下这么多的科学知识。",		-- 物品名:"超级胃增益电路" 制造描述:"能满足哪怕是最贪食的机器人的胃口。"
        WX78MODULE_MUSIC = "一个小玩意竟然装得下这么多的科学知识。",		-- 物品名:"合唱盒电路" 制造描述:"每台机器都需要时不时地进行校准。"
        WX78MODULE_BEE = "一个小玩意竟然装得下这么多的科学知识。",		-- 物品名:"豆增压电路" 制造描述:"让你的大脑和身体都充满嗡嗡作响的潜能！"
        WX78MODULE_MAXHEALTH2 = "一个小玩意竟然装得下这么多的科学知识。",		-- 物品名:"超级强化电路" 制造描述:"让你的机械身躯无比健壮。"
        WX78_SCANNER =
        {
            GENERIC ="WX-78真的把自己的一部分投入到了工作中。",		-- 物品名:"生物扫描分析仪"->默认
            HUNTING = "抓住那份数据！",		-- 物品名:"生物扫描分析仪"
            SCANNING = "它似乎发现了什么。",		-- 物品名:"生物扫描分析仪"
        },
        WX78_SCANNER_ITEM = "我想知道它是否会梦到扫描羊。",		-- 物品名:"生物扫描分析仪" 制造描述:"备份扫描永远不会有坏处。"
        WX78_SCANNER_SUCCEEDED = "它有一种迫不及待向世人展示自己作品的急迫。",		-- 物品名:"生物扫描分析仪"
        WX78_MODULEREMOVER = "这显然是一个非常精细和复杂的科学仪器。",		-- 物品名:"电路提取器" 制造描述:"成功的钳（前）提是努力。"
        SCANDATA = "闻起来像新鲜的研究。",		-- 物品名:"生物数据"
		JUSTEGGS = "可以再来点培根。",		-- 物品名:"普通煎蛋"
		VEGGIEOMLET = "早餐是一天中最科学的一餐。",		-- 物品名:"早餐锅"
        ...
        BOAT_ROTATOR_KIT = "我想我要带它出去转转。",		-- 物品名:"转向舵套装" 制造描述:"划，划，转动你的船。"
        BOAT_BUMPER_KELP = "虽然不能解决小船的所有问题，但也起到了海带应有的作用。",		-- 物品名:"海带保险杠"
        BOAT_BUMPER_KELP_KIT = "一个即将到来的船用保险杠。",		-- 物品名:"海带保险杠套装" 制造描述:"用海带保护你的船！"
		BOAT_BUMPER_SHELL = "能给小船提供一个小的防御外壳。",		-- 物品名:"贝壳保险杠"
        BOAT_BUMPER_SHELL_KIT = "一个即将到来的船用保险杠。",		-- 物品名:"贝壳保险杠套装" 制造描述:"用贝壳保护你的船！"
        BOAT_CANNON =
	{
            GENERIC = "我应该找东西装填进去。",		-- 物品名:"大炮"->默认
            AMMOLOADED = "大炮已经准备好开火了！",		-- 物品名:"大炮"
            NOAMMO = "我没忘记炮弹的事，我只是在酝酿群众的期待。",		-- 物品名:"大炮"
        },
        BOAT_CANNON_KIT = "现在还不是大炮，不过将来会是。",		-- 物品名:"大炮套装" 制造描述:"它能把你的竞争对手从水面轰走。"
        CANNONBALL_ROCK_ITEM = "它能完美地装进炮膛里。",		-- 物品名:"炮弹" 制造描述:"它肯定会引起轰动。"
        OCEAN_TRAWLER =
	{
        ...
        OCEAN_TRAWLER_KIT = "我应该把它放在有很多鱼的地方。",		-- 物品名:"海洋拖网捕鱼器套装" 制造描述:"海里有的是鱼。"
        BOAT_MAGNET =
        {
            GENERIC = "一直以来我都被物理学所吸引，就像……一样，怎么想不起那个词了。",		-- 物品名:"自动航行仪"->默认
            ACTIVATED = "奏效了！！呃，我当然一早就知道它能行。",		-- 物品名:"自动航行仪"
        },
        BOAT_MAGNET_KIT = "可以这么讲，这只是我的天才创意之一。",		-- 物品名:"自动航行仪套装" 制造描述:"你的个性并不是唯一具有磁性的东西。"
        BOAT_MAGNET_BEACON =
        {
            GENERIC = "附近只要有强磁铁就会受到它的吸引。",		-- 物品名:"自动航行灯塔"->默认 制造描述:"能把附近可能存在的任何滑稽的超大磁铁吸过来。"
            ACTIVATED = "磁力！",		-- 物品名:"自动航行灯塔" 制造描述:"能把附近可能存在的任何滑稽的超大磁铁吸过来。"
        },
        DOCK_KIT = "这里有为小船建造一个码头所需的一切。",		-- 物品名:"码头套装" 制造描述:"准备好你的码头审查。"
        DOCK_WOODPOSTS_ITEM = "啊哈！我就猜到码头缺了点东西。",		-- 物品名:"码头桩" 制造描述:"没有什么能比事后添加一些柱子更能说明“结构稳定”了。"
        MONKEYHUT =
        {
            GENERIC = "树屋过于易燃，并非最佳实验场所。",		-- 物品名:"猴子小屋"->默认
            BURNT = "我早就说吧！",		-- 物品名:"猴子小屋"->烧焦的
        },
        ...
        POLLY_ROGERSHAT = "一只小鸟告诉我它会派上用场。",		-- 物品名:"波莉·罗杰的帽子" 制造描述:"随帽子附送一只长羽毛的朋友。"
        ...
        PIRATE_FLAG_POLE = "喂！",		-- 物品名:"月亮码头海盗旗" 制造描述:"挂起你自己的海盗旗来模仿猴子掠夺者吧。"
        BLACKFLAG = "我记得家中还有一副战旗。",		-- 物品名:"黑旗"
        PIRATE_STASH = "我喜欢这个装饰。",		-- 物品名:"X"
        STASH_MAP = "在生活中有一些方向是极好的。",		-- 物品名:"海盗地图"
        BANANAJUICE = "有点落草为寇的感觉了。",		-- 物品名:"香蕉奶昔"
        FENCE_ROTATOR = "注意！重新部署！",		-- 物品名:"栅栏击剑" 制造描述:"一把用于栅栏和击剑的剑"
        ...
        STAGEUSHER =
        {
            ...
            SITTING = "这里有些古怪，但我说不出所以然。",		-- 物品名:"多刺舞台之手"
        },
        SEWING_MANNEQUIN =
        {
            GENERIC = "即使打扮得漂漂亮亮，还是哪也去不了。",		-- 物品名:"假人"->默认 制造描述:"测试所有最新可装备外观的模特。"
            BURNT = "即使烧光了，还是哪也去不了。",		-- 物品名:"假人"->烧焦的 制造描述:"测试所有最新可装备外观的模特。"
        },
		MAGICIAN_CHEST = "为什么我开始感到有点不安了……？",		-- 物品名:"魔术师箱子" 制造描述:"将你的物品囚禁在一个暗影漩涡中。"
		TOPHAT_MAGICIAN = "那顶帽子流露着时尚。",		-- 物品名:"魔术师高礼帽" 制造描述:"百搭的黑魔法。"
        YOTR_FIGHTRING_KIT = "它一定是为了科学而建造的！",		-- 物品名:"枕头大战坑套装" 制造描述:"兔子的战斗擂台。"
        YOTR_FIGHTRING_BELL =
        {
            GENERIC = "暂时平静下来了。",		-- 物品名:"枕头大战钟"->默认
            PLAYING = "我想我们今天都在这里学到了很多东西。",		-- 物品名:"枕头大战钟"
        },
        YOTR_DECOR_1 =
	{
        ...
        YOTR_DECOR_2 =
	{
		...
		DREADSTONE = "它竟然反射暗影而非光线。",		-- 物品名:"绝望石"
		HORRORFUEL = "它让我脊椎发出了可怕的颤抖。",		-- 物品名:"纯粹恐惧"
		DAYWALKER =
		{
			GENERIC = "释放他可能有些草率了。",		-- 物品名:"噩梦猪人"->默认
			IMPRISONED = "我有些为他惋惜。",		-- 物品名:"噩梦猪人"
		},
		DAYWALKER_PILLAR =
		{
		...
		SHOVEL_LUNARPLANT = "转移泥土的潜力无限大！",		-- 物品名:"亮茄锄铲" 制造描述:"铲子和园艺锄之间交叉授粉的突破性成果。"
		BROKEN_FORGEDITEM = "它破损了，但是我可以把它修好。",		-- 物品名:"开裂的柱子"
		...
		SHADOWTHRALL_HANDS = "把手拿开！",		-- 物品名:"墨荒"
		SHADOWTHRALL_HORNS = "它看起来渴望战斗。",		-- 物品名:"墨荒"
		SHADOWTHRALL_WINGS = "翅膀貌似仅仅是用来看的。",		-- 物品名:"墨荒"
        ...
        IPECACSYRUP = "我不太想吃这个。",		-- 物品名:"泻根糖浆" 制造描述:"让你保持正常。"
        ...
        WORMWOOD_MUTANTPROXY_CARRAT =
        {
        	...
        	HELD = "近看真是丑。",		-- 物品名:未找到
        	SLEEPING = "有点可爱了。",		-- 物品名:未找到
        },
        WORMWOOD_MUTANTPROXY_LIGHTFLIER = "真是奇怪，装在我的口袋里居然还能发光！",		-- 物品名:未找到
		WORMWOOD_MUTANTPROXY_FRUITDRAGON =
		{
			GENERIC = "挺可爱的，不过还没熟。",		-- 物品名:未找到
			RIPE = "现在应该熟了。",		-- 物品名:未找到
			SLEEPING = "在打盹呢。",		-- 物品名:未找到
		},
		...
		SUPPORT_PILLAR_DREADSTONE_SCAFFOLD = "目前一切都处于保密状态。",		-- 物品名:"绝望石支柱脚手架" 制造描述:"黑暗的力量在压力下仍能保持良好的状态。"
		SUPPORT_PILLAR_DREADSTONE = "我得尽快抽出时间来解决这个问题。",		-- 物品名:"绝望石支柱"
		SUPPORT_PILLAR_DREADSTONE_COMPLETE = "看起来强大得可怕。",		-- 物品名:"强化绝望石支柱"
		SUPPORT_PILLAR_DREADSTONE_BROKEN = "多么可怕啊。",		-- 物品名:"绝望石支柱瓦砾"
        ...
        DEERCLOPSCORPSE =
        {
            ...
            REVIVING = "我不愿相信双眼正在看到的这一切！",		-- 物品名:未找到
        },
        WARGCORPSE =
        {
            GENERIC  = "为什么我仍然感到不安？",		-- 物品名:未找到
            BURNING  = "一切都是最好的安排。",		-- 物品名:未找到
            REVIVING = "以科学的名义，这是什么玩意？！",		-- 物品名:未找到
        },
        BEARGERCORPSE =
        {
            GENERIC  = "臭不可闻！",		-- 物品名:未找到
            BURNING  = "好险。",		-- 物品名:未找到
            REVIVING = "这一定有科学的解释！",		-- 物品名:未找到
        },
        BEARGERFUR_SACK = "上面还有它的毛。寒毛直竖啊。",		-- 物品名:"极地熊獾桶" 制造描述:"便携式冰箱。酷。"
        HOUNDSTOOTH_BLOWPIPE = "牙齿？那可不太卫生啊。",		-- 物品名:"嚎弹炮" 制造描述:"那感觉就像远距离被咬一样。"
        DEERCLOPSEYEBALL_SENTRYWARD =
        {
            GENERIC = "这才叫冰冷的目光吧？",    -- Enabled.		-- 物品名:"冰眼结晶器"->默认
            NOEYEBALL = "是谁丢了一只眼睛呢？",  -- Disabled.		-- 物品名:"冰眼结晶器"
        },
        ...
        WOOD_CHAIR =
        {
            GENERIC = "我想坐上去！",		-- 物品名:"木椅"->默认 制造描述:"一把可以坐的木椅。"
            OCCUPIED = "别人在坐着。",		-- 物品名:"木椅"->被占领 制造描述:"一把可以坐的木椅。"
            BURNT = "我可不想坐上去。",		-- 物品名:"木椅"->烧焦的 制造描述:"一把可以坐的木椅。"
        },
        ...
        DECOR_FLOWERVASE =
        {
            ...
            OLDLIGHT = "我记得告诉过麦斯威尔换灯泡的。",		-- 物品名:"餐桌花瓶"->茶几-旧的发光的 制造描述:"这是一个放置鲜切花的好地方。"
        },
        DECOR_PICTUREFRAME =
        {
            GENERIC = "真美啊。",		-- 物品名:"空画框"->默认 制造描述:"将你最爱的物品图装裱起来。 "
            UNDRAWN = "我应该画点东西在里面。",		-- 物品名:"空画框"->没有画画 制造描述:"将你最爱的物品图装裱起来。 "
        },
        ...
        RECORD_CREEPYFOREST = "一张唱片能录一整首歌？技术已经走到了这一步。",		-- 物品名:"惊悚森林"
        RECORD_DANGER = "不是我最喜欢的。",		-- 物品名:"空画框" 制造描述:"将你最爱的物品图装裱起来。 "
        RECORD_DAWN = "需要多一点小号。",		-- 物品名:"空画框" 制造描述:"将你最爱的物品图装裱起来。 "
        RECORD_DRSTYLE = "一张唱片能录一整首歌？技术已经走到了这一步。",		-- 物品名:"D.R.风格"
        RECORD_DUSK = "需要多一点小号。",		-- 物品名:"空画框" 制造描述:"将你最爱的物品图装裱起来。 "
        RECORD_EFS = "更实验性的曲目。",		-- 物品名:"E.F.S."
        RECORD_END = "一张唱片能录一整首歌？技术已经走到了这一步。",		-- 物品名:"空画框" 制造描述:"将你最爱的物品图装裱起来。 "
        RECORD_MAIN = "需要多一点小号。",		-- 物品名:"空画框" 制造描述:"将你最爱的物品图装裱起来。 "
        RECORD_WORKTOBEDONE = "更实验性的曲目。",		-- 物品名:"空画框" 制造描述:"将你最爱的物品图装裱起来。 "
        ...
        BATTLESONG_SHADOWALIGNED = "戏剧让我坐立不安。",		-- 物品名:"黑暗悲歌" 制造描述:"帮自己和盟友抵御月亮敌人。"
        BATTLESONG_LUNARALIGNED = "戏剧让我坐立不安。",		-- 物品名:"启迪摇篮曲" 制造描述:"帮自己和盟友抵御暗影敌人。"
    ...
    DESCRIBE_PLANTHAPPY = "多么快乐的植物啊!",		--检查植物 植物满足
    DESCRIBE_PLANTVERYSTRESSED = "这株植物似乎承受了很大的压力。",		--检查植物 植物压力山大(没戴眼镜时检查)
    DESCRIBE_PLANTSTRESSED = "它有点暴躁。",		--检查植物 植物有压力(没戴眼镜时检查)
    DESCRIBE_PLANTSTRESSORKILLJOYS = "我可能要除一下草……",		--检查植物 有讨厌的(腐烂的大蔬菜、杂草、土壤杂物碎片)
    DESCRIBE_PLANTSTRESSORFAMILY = "我的科学结论是这株植物很孤独。",		--检查植物 同类作物不足
    DESCRIBE_PLANTSTRESSOROVERCROWDING = "植物太多，地方太小。",		--检查植物 过度拥挤
    DESCRIBE_PLANTSTRESSORSEASON = "这个季节对这株植物并不友好。",		--检查植物 季节错误
    DESCRIBE_PLANTSTRESSORMOISTURE = "看起来有点脱水。",		--检查植物 缺少水分
    DESCRIBE_PLANTSTRESSORNUTRIENTS = "这颗可怜的植物需要营养!",		--检查植物 缺少养分
    DESCRIBE_PLANTSTRESSORHAPPINESS = "它想找人好好聊聊。",		--检查植物 没聊天
    EAT_FOOD =
    {
        TALLBIRDEGG_CRACKED = "嗯，鸟嘴。",		--吃孵化的高脚鸟蛋
		WINTERSFEASTFUEL = "它尝起来是节日的味道。",		--吃冬季盛宴食物
    },
}
